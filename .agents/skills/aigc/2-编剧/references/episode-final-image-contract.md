...
- `.agents/skills/aigc/4-导演/references/episode-visual-spine-contract.md` 负责整集视觉主轴，`callback_targets` 中的未闭合母题可作为尾钩候选；本文件负责将其转化为终结画面的空间/道具/情绪落点。
- `.agents/skills/aigc/6-氛围/references/atmosphere-and-mood-contract.md` 负责五感氛围和意境技法；本文件使用其中留白、静物、延时承托和反衬技法制造尾钩。
