...
| `G5-SLOTS` | 只绑定存在图片，多视图优先，缺图不留空路径 | `FAIL-SHEET-REF` | `references/reference-slot-binding.md` |
...
| `G8-REF-INPUT` | 若使用 built-in text prompt only，results/report 明确记录 reference paths 未作为视觉输入 | `FAIL-SHEET-IMAGEGEN` | `references/imagegen-handoff.md` |
