...
定场镜头：<本集首组无上一组时，先描述场景身份和环境身份，再描述全部可见或需要生成角色的站位、站/坐/蹲/躺/靠等姿态、空间方位关系和朝向>
...
定场镜头：承接上一组结束状态，<先说明上一组末尾的角色位置、姿态、朝向或未完成动作如何延续为本组开端；再重新描述本组开始时的场景身份、环境身份、全部角色站位、姿态、空间方位关系和朝向>
