...
`$aigc-prop-generation` 是 AIGC 工作流中 `7-设计/道具/3-生成` 的 Skill 2.0 包。它消费上游 `2-设计` 的单道具设计文档，调用 `$imagegen` 生成单主体图与多视图主体设计图。
...
- 输入：`projects/aigc/<项目名>/7-设计/道具/2-设计/<主体名称>.md`
- 输出：`projects/aigc/<项目名>/7-设计/道具/3-生成/`
...
- 结构校验：`python3 /Users/vincentlee/.codex/skills/meta/构建/技能/skill-工作车间/scripts/validate_skill_2_0.py .agents/skills/aigc/7-设计/道具/3-生成`
