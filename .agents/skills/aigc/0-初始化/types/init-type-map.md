...
| --- | --- | --- | --- |
| `new_scaffold` | new AIGC film/video project init | project name and optional memory requirements | current `1-10` directories plus `MEMORY.md` |
| `repair_scaffold` | existing project missing scaffold directories | existing project root | missing current `1-10` directories plus preserved `MEMORY.md` |
