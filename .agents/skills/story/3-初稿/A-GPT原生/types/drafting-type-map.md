...
| `context_pack` | `projects/story/<项目名>/reports/3-初稿/gpt-native/.../*messages.json` | GPT 原生创作输入证据 |
| `gpt_native_sidecar` | `projects/story/<项目名>/reports/3-初稿/gpt-native/.../` | GPT 原生过程证据 |
