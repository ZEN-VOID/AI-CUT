...
def default_design_path(project: str, episode: str) -> Path:
    return Path("projects") / "aigc" / project / "4-Design" / "场景" / "2-设计" / episode / "scene_design.json"


def default_output_root(project: str, episode: str) -> Path:
    return Path("projects") / "aigc" / project / "4-Design" / "场景" / "3-面板" / episode
    ...
    for task in tasks:
        ...
        layout_payload = {
            "meta": {
                ...
                "skill_id": "aigc/4-Design/3-面板/场景",
