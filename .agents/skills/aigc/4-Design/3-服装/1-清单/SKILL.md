...
- 输出根仍固定为 `projects/<项目名>/4-Design/3-服装/1-清单/第N集/`
...
6. `projects/<项目名>/4-Design/2-角色/1-清单/第N集/角色清单.json`
...
- 已存在的 `projects/<项目名>/4-Design/3-服装/1-清单/第N集/*.json`
  - 仅用于增量修补或覆盖比对
...
5. 三份 JSON 全部落到 `projects/<项目名>/4-Design/3-服装/1-清单/第N集/`。
...
1. `projects/<项目名>/4-Design/3-服装/1-清单/第N集/服装清单.json`
2. `projects/<项目名>/4-Design/3-服装/1-清单/第N集/服装研究.json`
3. `projects/<项目名>/4-Design/3-服装/1-清单/第N集/costume_design_bridge.json`
