...
- 根目录：`projects/<项目名>/4-主体/1-清单/`
- 角色：
  - `projects/<项目名>/4-主体/1-清单/角色清单/第N集/角色清单.json`
  - `projects/<项目名>/4-主体/1-清单/角色清单/第N集/role_design_bridge.json`
- 场景：
  - `projects/<项目名>/4-主体/1-清单/场景清单/第N集/场景清单.json`
  - `projects/<项目名>/4-主体/1-清单/场景清单/第N集/scene_design_bridge.json`
- 道具：
  - `projects/<项目名>/4-主体/1-清单/道具清单/第N集/道具清单.json`
  - `projects/<项目名>/4-主体/1-清单/道具清单/第N集/prop_design_bridge.json`
- 验收：`projects/<项目名>/4-主体/1-清单/validation-report.md`
