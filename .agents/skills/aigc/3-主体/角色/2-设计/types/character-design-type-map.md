...
| --- | --- | --- | --- |
| `lead + strong` | 完整研究、物语、视觉服装、摄影，`aesthetic_priority=lead_heightened`，`charisma_floor=high_lead` | 角色矛盾、长期视觉识别、跨场景一致性、最高级别镜头完成度和服装系统；审美路线必须来源匹配，魅力证据必须可见 | 避免过度百科化，避免把审美强化写成模板脸或性别化默认美/帅 |
...
| `villain / antagonist` | 按角色权重选择完整或中等篇幅，`aesthetic_priority=villain_charismatic`；大反派/主要对抗者使用 `charisma_floor=high_major_antagonist` | 危险、锋利、阴郁、病态或怪诞魅力；大反派必须有压迫性镜头魅力，普通反派至少有清晰辨识度 | 避免把反派写丑、脏、乱作为唯一视觉逻辑；避免把大反派降格为“可识别即可” |
...
| profile signal | aesthetic_priority / charisma_floor | required output |
| --- | --- | --- |
| 主角、核心情感线、长期复用角色 | `lead_heightened` + `charisma_floor=high_lead` | `Source-Fit Aesthetic Target` 与 `Charisma Floor` 必须明确来源匹配的高吸引力目标；脸型、骨相、眼神、妆发、身形、姿态和服装完成度都要可见 |
...
- 主角必须在审美层明确更高的镜头完成度、气质和服装系统；大反派/主要对抗者必须明确压迫性镜头魅力、危险吸引力或权力气场；两者都不得按女性美丽、男性英俊机械默认，也不得只写“可识别”。
