...
6. 使用 `templates/output-template.md` 输出到 `projects/aigc/<项目名>/11-主体/道具/2-设计/PROP-###-<安全文件名>.md`。
...
- 道具必须好看、有设计感、有文化元素和可见细节；不得只是简单功能还原或平凡物件。普通功能道具也至少需要材质、比例、磨损、结构或工艺上的设计美感。
- 文化元素、纹样、铭文、徽记、封缄、器型、材质和装饰必须符合项目时代、地域、阶层、职业、宗教/族群禁区与功能逻辑；风格化不能脱离时代语境。
