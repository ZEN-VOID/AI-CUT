...
`1-清单` 是 `5-设计` 阶段承接 `3-Detail`、连接 `2-设计` 的阶段父 skill。
...
| 单元 | 当前状态 | 第一输入根 | 默认输出根 |
| --- | --- | --- | --- |
| `场景` | active | `3-Detail/第N集.json` | `5-设计/场景/1-清单/第N集/` |
| `角色` | active | `3-Detail/第N集.json` | `5-设计/角色/1-清单/第N集/` |
| `服装` | pending-migration | `5-设计/角色/1-清单/第N集/角色清单.json` | 暂不声明 active runtime；不得在初始化时预建 `5-设计/服装/*` |
| `道具` | active | `3-Detail/第N集.json` | `5-设计/道具/1-清单/第N集/` |
...
- 强制读取：`.agents/skills/aigc/5-设计/1-清单/_shared/detail-output-consumption-contract.md`
- 强制读取：`.agents/skills/aigc/5-设计/1-清单/_shared/object-normalization-contract.md`
- 强制读取：`.agents/skills/aigc/5-设计/1-清单/_shared/list-output-contract.md`
- 强制读取：`道具/SKILL.md`
- 条件读取：`场景/SKILL.md`
- 条件读取：`角色/SKILL.md`
- 条件读取：`服装/SKILL.md`
...
10. `.agents/skills/aigc/5-设计/1-清单/_shared/detail-output-consumption-contract.md`
11. `.agents/skills/aigc/5-设计/1-清单/_shared/object-normalization-contract.md`
12. `.agents/skills/aigc/5-设计/1-清单/_shared/list-output-contract.md`
...
- `Rule Source`
  - `.agents/skills/aigc/5-设计/1-清单/SKILL.md`
