...
CHECKPOINT_REQUIREMENTS = {
    "init-handoff-ready": {
        ...
        "source_truth_refs": ["MEMORY.md"],
        "runtime_artifact_refs": ["0-初始化/", "MEMORY.md"],
        "handoff_candidate_refs": ["1-分集/"],
    },
    "episode-split-ready": {
        "validation_refs": ["1-分集/validation-report.md"],
        "source_truth_refs": ["MEMORY.md", "1-分集/"],
        "runtime_artifact_refs": ["1-分集/"],
        "handoff_candidate_refs": ["2-编剧/"],
    },
    "screenwriting-ready": {
        "validation_refs": ["2-编剧/validation-report.md"],
        "source_truth_refs": [
            "1-分集/{scope_ref}.md",
            "2-编剧/{scope_ref}.md",
        ],
        "runtime_artifact_refs": ["2-编剧/{scope_ref}.md"],
        "handoff_candidate_refs": ["3-美学/"],
    },
    "aesthetic-ready": {
        "validation_refs": ["3-美学/validation-report.md"],
        "source_truth_refs": [
            "2-编剧/{scope_ref}.md",
            "3-美学/",
        ],
        "runtime_artifact_refs": ["3-美学/"],
        "handoff_candidate_refs": ["4-导演/"],
    },
    "director-ready": {
        "validation_refs": ["4-导演/validation-report.md"],
        "source_truth_refs": [
            "2-编剧/{scope_ref}.md",
            "3-美学/",
            "4-导演/{scope_ref}.md",
        ],
        "runtime_artifact_refs": ["4-导演/{scope_ref}.md"],
        "handoff_candidate_refs": ["5-表演/"],
    },
    "performance-ready": {
        "validation_refs": ["5-表演/validation-report.md"],
        "source_truth_refs": [
            "4-导演/{scope_ref}.md",
            "5-表演/{scope_ref}.md",
        ],
        "runtime_artifact_refs": ["5-表演/{scope_ref}.md"],
        "handoff_candidate_refs": ["6-氛围/"],
    },
    "atmosphere-ready": {
        "validation_refs": ["6-氛围/validation-report.md"],
        "source_truth_refs": [
            "5-表演/{scope_ref}.md",
            "6-氛围/{scope_ref}.md",
        ],
        "runtime_artifact_refs": ["6-氛围/{scope_ref}.md"],
        "handoff_candidate_refs": ["7-分镜/"],
    },
    "storyboard-ready": {
        "validation_refs": ["7-分镜/validation-report.md"],
        "source_truth_refs": [
            "6-氛围/{scope_ref}.md",
            "7-分镜/{scope_ref}.md",
        ],
        "runtime_artifact_refs": ["7-分镜/{scope_ref}.md"],
        "handoff_candidate_refs": ["8-摄影/"],
    },
    "cinematography-ready": {
        "validation_refs": ["8-摄影/validation-report.md"],
        "source_truth_refs": [
            "7-分镜/{scope_ref}.md",
            "8-摄影/{scope_ref}.md",
        ],
        "runtime_artifact_refs": ["8-摄影/{scope_ref}.md"],
        "handoff_candidate_refs": ["9-光影/"],
    },
    "lighting-ready": {
        "validation_refs": ["9-光影/validation-report.md"],
        "source_truth_refs": [
            "8-摄影/{scope_ref}.md",
            "9-光影/{scope_ref}.md",
        ],
        "runtime_artifact_refs": ["9-光影/{scope_ref}.md"],
        "handoff_candidate_refs": ["10-分组/"],
    },
    "grouping-ready": {
        "validation_refs": ["10-分组/validation-report.md"],
        "source_truth_refs": [
            "9-光影/{scope_ref}.md",
            "10-分组/{scope_ref}.md",
        ],
        "runtime_artifact_refs": ["10-分组/{scope_ref}.md"],
        "handoff_candidate_refs": ["11-主体/"],
    },
    "design-ready": {
        "validation_refs": ["11-主体/validation-report.md"],
        "source_truth_refs": [
            "10-分组/{scope_ref}.md",
            "11-主体/",
        ],
        "runtime_artifact_refs": ["11-主体/"],
        "handoff_candidate_refs": ["12-图像/", "13-画布/"],
    },
    "image-request-ready": {
    ...
    "video-subject-reference-ready": {
        "validation_refs": ["13-画布/validation-report.md"],
        "source_truth_refs": [
            "11-主体/",
            "12-图像/",
            "13-画布/C-主体参照/",
        ],
        "runtime_artifact_refs": ["13-画布/C-主体参照/"],
        "handoff_candidate_refs": ["13-画布/C-主体参照/"],
    },
    "video-handoff-ready": {
        "validation_refs": ["13-画布/validation-report.md"],
        ...
        "runtime_artifact_refs": ["13-画布/C-主体参照/"],
        "handoff_candidate_refs": ["Assets/", "13-画布/C-主体参照/"],
    },
    "package-release-ready": {
        "validation_refs": [
            "1-分集/validation-report.md",
            "2-编剧/validation-report.md",
            "3-美学/validation-report.md",
            "4-导演/validation-report.md",
            "5-表演/validation-report.md",
            "6-氛围/validation-report.md",
            "7-分镜/validation-report.md",
            "8-摄影/validation-report.md",
            "9-光影/validation-report.md",
            "10-分组/validation-report.md",
            "11-主体/validation-report.md",
            "12-图像/validation-report.md",
            "13-画布/validation-report.md",
        ],
        "source_truth_refs": [
            "MEMORY.md",
            "1-分集/",
...
STAGE_REQUIREMENTS = {
    ...
    "2-编剧": CHECKPOINT_REQUIREMENTS["screenwriting-ready"],
    "3-美学": CHECKPOINT_REQUIREMENTS["aesthetic-ready"],
    "4-导演": CHECKPOINT_REQUIREMENTS["director-ready"],
    "5-表演": CHECKPOINT_REQUIREMENTS["performance-ready"],
    "6-氛围": CHECKPOINT_REQUIREMENTS["atmosphere-ready"],
    "7-分镜": CHECKPOINT_REQUIREMENTS["storyboard-ready"],
    "8-摄影": CHECKPOINT_REQUIREMENTS["cinematography-ready"],
    "9-光影": CHECKPOINT_REQUIREMENTS["lighting-ready"],
    "10-分组": CHECKPOINT_REQUIREMENTS["grouping-ready"],
    "11-主体": CHECKPOINT_REQUIREMENTS["design-ready"],
    "12-图像": {
        "validation_refs": ["12-图像/validation-report.md"],
        "source_truth_refs": ["10-分组/", "11-主体/", "12-图像/"],
        "runtime_artifact_refs": ["12-图像/"],
        "handoff_candidate_refs": ["13-画布/", "Assets/"],
    },
    "13-画布": {
        "validation_refs": ["13-画布/validation-report.md"],
        "source_truth_refs": ["12-图像/", "13-画布/"],
        "runtime_artifact_refs": ["13-画布/"],
        "handoff_candidate_refs": ["Assets/", "validation-report.md"],
    },
}
...
DIMENSION_EXPECTATIONS = {
    "planning-seed-validator": {
        "source_prefixes": ["MEMORY.md", "0-初始化/", "1-分集/", "2-编剧/"],
        "validation_prefixes": ["0-初始化/", "1-分集/", "2-编剧/"],
    },
    "detail-execution-validator": {
        "source_prefixes": ["2-编剧/", "3-美学/", "4-导演/", "5-表演/", "6-氛围/", "7-分镜/", "8-摄影/", "9-光影/", "10-分组/"],
        "runtime_prefixes": ["4-导演/", "5-表演/", "6-氛围/", "7-分镜/", "8-摄影/", "9-光影/", "10-分组/"],
        "validation_prefixes": ["2-编剧/", "3-美学/", "4-导演/", "5-表演/", "6-氛围/", "7-分镜/", "8-摄影/", "9-光影/", "10-分组/"],
    },
    "design-alignment-validator": {
        "source_prefixes": ["10-分组/", "11-主体/"],
        "runtime_prefixes": ["11-主体/"],
        "validation_prefixes": ["11-主体/"],
    },
    "image-delivery-validator": {
        "source_prefixes": ["10-分组/", "11-主体/", "12-图像/"],
        "runtime_prefixes": ["12-图像/"],
        "validation_prefixes": ["12-图像/"],
    },
    "video-delivery-validator": {
        "source_prefixes": ["10-分组/", "11-主体/", "12-图像/", "13-画布/"],
        "runtime_prefixes": ["13-画布/"],
        "validation_prefixes": ["13-画布/"],
    },
    "governance-closure-validator": {
        "use_fact_pack_validation_refs": True,
        "runtime_refs": ["STATE.json", "governance-state.yaml", "MEMORY.md"],
    },
}
