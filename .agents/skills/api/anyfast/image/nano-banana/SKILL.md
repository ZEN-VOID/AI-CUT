...
```bash
python3 .agents/skills/api/anyfast/image/nano-banana/scripts/nano_banana_generate.py [参数]
```
...
- 接口摘要：`.agents/skills/api/anyfast/image/nano-banana/references/api.md`
...
-> `规则源`：`.agents/skills/api/anyfast/image/nano-banana/SKILL.md` 与 `scripts/nano_banana_generate.py`
