...
任何 subagent 都不得直接写 `projects/<项目名>/4-Design/3-服装/2-设计/第N集/*`。
...
- `1-清单` 尚未完成，应先回到 `4-Design/3-服装/1-清单`。
...
| `business_object` | 服装对象池、研究层、bridge、角色设计约束、导演证据、全局风格、类型指导、服装设计组 patch |
...
4. `.agents/skills/aigc/4-Design/3-服装/SKILL.md + CONTEXT.md`
5. 本 `SKILL.md + CONTEXT.md`
6. `.agents/skills/aigc/4-Design/3-服装/2-设计/_shared/IO_CONTRACT.md`
...
11. `projects/<项目名>/2-Global/类型指导.md`
12. `projects/<项目名>/4-Design/3-服装/1-清单/第N集/服装清单.json`
13. `projects/<项目名>/4-Design/3-服装/1-清单/第N集/服装研究.json`
14. `projects/<项目名>/4-Design/3-服装/1-清单/第N集/costume_design_bridge.json`
15. `projects/<项目名>/4-Design/2-角色/2-设计/第N集/character_design.json`
...
- 已存在的 `projects/<项目名>/4-Design/3-服装/2-设计/第N集/*`
...
| `DW3` | 路径归一 | 写到 `projects/<项目名>/4-Design/3-服装/2-设计/第N集/` | 不允许漂移到其他 sibling |
...
1. `projects/<项目名>/4-Design/3-服装/2-设计/第N集/服装设计.json`
2. `projects/<项目名>/4-Design/3-服装/2-设计/第N集/costume_design_prompt.json`
3. `projects/<项目名>/4-Design/3-服装/2-设计/第N集/<costume_id>-<canonical_label>.md`
4. `projects/<项目名>/4-Design/3-服装/2-设计/第N集/_manifest.json`
