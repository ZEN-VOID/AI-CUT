...
output_root: `projects/aigc/<项目名>/6-设计/场景/3-生成`
...
```json
{
  ...
  "stage": "6-设计/场景/3-生成",
  "source_design_document": "projects/aigc/<项目名>/6-设计/场景/2-设计/S###-<场景名>.md",
  "subject_id": "<主体ID>",
  ...
  "output_path": "projects/aigc/<项目名>/6-设计/场景/3-生成/<主体ID>-<主体名称>-主图.png",
  "review": {
    "verdict": "pending",
    "notes": ""
  },
...
| Output path | All asset examples point to `projects/aigc/<项目名>/6-设计/场景/3-生成`. |
