...
| slot | question |
| --- | --- |
| `business_goal` | 本轮要完成分集、剧本格式化、分组、完整规划链，还是只做验收/修复？ |
| `business_object` | 输入对象是 `Story/`、`1-分集` 输出、`2-格式` 主稿、`3-分组` 结果，还是技能包结构本身？ |
| `constraint_profile` | 约束来自故事源 readiness、剧本变体、组界量化、项目 runtime，还是 Skill 2.0 结构？ |
...
| `FAIL-PLAN-04` | 剧本变体或格式 validator 失败 | `references/script-format-contract.md`、`scripts/validate_script_output.py` |
