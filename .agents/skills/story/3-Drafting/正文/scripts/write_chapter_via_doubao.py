#!/usr/bin/env python3
"""
Bridge script for `story/3-Drafting/正文`.
...
ZHENGWEN_DIR = SCRIPT_PATH.parents[1]
...
SYSTEM_PROMPT_PATH = ZHENGWEN_DIR / "templates" / "doubao-system-prompt.md"
CHAPTER_TEMPLATE_PATH = ZHENGWEN_DIR / "templates" / "chapter-root.template.md"
...
def _default_output_dir(project_root: Path, volume_num: int, chapter_num: int) -> Path:
    return project_root / "reports" / "3-Drafting" / "正文" / f"第{volume_num}卷" / f"第{chapter_num}章" / "doubao"
