...
- 必须读取对应上游设计文档：`projects/aigc/<项目名>/11-主体/道具/2-设计/<主体名称>.md`。
...
- 用户要求“道具生成”“道具生图”“从道具设计文档生成图像”“配置或执行 11-主体/道具/3-生成”等任务。
- 单个道具名称、多个道具名称，或默认处理 `道具/2-设计` 中全部目标设计文档。

Required input:

- 可定位的 `projects/aigc/<项目名>/11-主体/道具/2-设计/`。
...
2. 锁定被调度的上游 `2-设计` 文档，并读取可选 `projects/aigc/<项目名>/11-主体/道具/design-manifest.yaml`；只消费这些文档，不为未调度主体补空图、补占位 JSON 或重写设计正文。
...
6. 写入 canonical 路径 `projects/aigc/<项目名>/11-主体/道具/3-生成/`，并可更新 `design-manifest.yaml` 的 `generation_assets` 与 `generation_gaps`；不得修改 `2-设计`、父级 registry、角色/场景生成目录或其他 worker 文件。
...
4. 可选更新 `projects/aigc/<项目名>/11-主体/道具/design-manifest.yaml`，记录 `generation_assets` 和剩余 `generation_gaps`；manifest 不替代生成资产真源。
...
| --- | --- |
| `OUTPUT-PROP-MAIN-IMAGE` | `projects/aigc/<项目名>/11-主体/道具/3-生成/<主体ID>-<主体名称>-主图.<ext>` |
| `OUTPUT-PROP-MAIN-PROMPT` | `projects/aigc/<项目名>/11-主体/道具/3-生成/<主体ID>-<主体名称>-主图.json` |
| `OUTPUT-PROP-MULTIVIEW-IMAGE` | `projects/aigc/<项目名>/11-主体/道具/3-生成/<主体ID>-<主体名称>-多视图.<ext>` |
| `OUTPUT-PROP-MULTIVIEW-PROMPT` | `projects/aigc/<项目名>/11-主体/道具/3-生成/<主体ID>-<主体名称>-多视图.json` |
| `OUTPUT-PROP-GEN-REPORT` | `projects/aigc/<项目名>/11-主体/道具/3-生成/执行报告.md` |
