...
| Output path | `projects/aigc/<项目名>/9-图像/分镜平面图/第N集/` |
...
| upstream_context | direction_role | used_as | spatial_decision | panel_or_output_anchor | boundary_check | evidence_map |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |
