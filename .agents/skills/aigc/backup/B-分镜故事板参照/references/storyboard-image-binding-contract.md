...
| --- | --- | --- | --- | --- |
| 故事板图候选是否只从 `6-图像/B-分镜故事板/第N集/` 与 `images/` 两个固定根读取？ | `GATE-SBVID-05` | `FAIL-SBVID-REF` | `N4-REF-BIND` | reference manifest 记录 search roots、episode dir、images dir |
...
| 参照图是否只作为 storyboard visual reference，没有反向改写 `4-分组` 的剧情、镜头、对白或场景事实？ | `GATE-SBVID-11` | `FAIL-SBVID-FIDELITY` | `N5-YAML` / `N6-REVIEW` | prompt/source 对照、report 中无 reverse rewrite |
