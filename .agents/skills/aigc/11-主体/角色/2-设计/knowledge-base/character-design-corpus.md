...
usage_boundary:
  ...
  - "明星脸灵感只能抽象为骨相、眼神、妆发和镜头魅力，不生成可识别现实人物。"
```
...
| --- | --- | --- |
| 不做平淡还原 | 清单关键词先转为审美目标，再转为脸、妆、身形、服装 | 使用可见名词和材质词，不只写 beautiful / handsome |
| 女性美丽动人 | 明确眼神、眉形、唇色、肤质、发型、身形比例和服装曲线 | `delicate yet striking beauty`, `luminous eyes`, `soft sculpted makeup` |
| 男性英俊不凡 | 明确眉骨、鼻梁、颌线、肩颈、站姿、服装线条 | `sharp brows`, `clear jawline`, `commanding posture` |
| 主角更强 | 主角必须有高记忆点脸部、妆发和服装 signature | `lead-character presence`, `cinematic leading-face quality` |
| 反派也要有魅力 | 危险、阴郁、病态、锋利、怪诞都要可控而好看 | `charismatic menace`, `controlled dark elegance` |
...
| aesthetic target | face and makeup tokens | costume tokens | avoid |
| --- | --- | --- | --- |
| 雄健英武 | 浓眉、眼神直、鼻梁硬、下颌宽、肤色有户外质感 | 盔甲或劲装需符合时代兵制，护腕、腰封、靴履有磨损 | 现代战术服硬套古代武将 |
...
| aesthetic target | face and makeup tokens | costume tokens | avoid |
| --- | --- | --- | --- |
| 质朴但好看 | 肤色自然、眉眼干净、发丝收束、表情有生活感 | 粗细材质有对比、补丁/磨损有秩序、色彩受资源限制 | 写成脏乱、灰扑扑、没有设计 |
...
| 现代感 | 职业服、街装、礼服、制服、亚文化造型 | 职业真实性、生活磨损、品牌泛化风险 | 只有潮牌词，没有角色身份 |
