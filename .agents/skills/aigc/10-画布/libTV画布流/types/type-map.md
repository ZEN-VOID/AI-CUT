...
| --- | --- | --- | --- |
| `full_canvas_control` | 在目标项目空间下创建或选择新画布、上传主体参照、回刷 YAML、创建视频节点 | `types/full-canvas-control.md` | `SKILL.md#Thinking-Action Node Map` |
...
7. 所有路线最终回到 `SKILL.md#Thinking-Action Node Map`，不得使用 `steps/` 维护第二执行链。
