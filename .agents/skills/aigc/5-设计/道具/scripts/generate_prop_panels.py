...
def _default_output_dir(project_name: str, episode_id: str) -> Path:
    return _repo_root() / "projects" / "aigc" / project_name / "5-设计"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="从 5-设计/道具 域级设计输出生成道具面板 layout JSON，并默认自动生图。")
