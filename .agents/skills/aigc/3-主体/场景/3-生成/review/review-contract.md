...
| `continuity-reviewer` | Main image continuity and multiview cancellation | missing main image, people/silhouette drift, multi-view restored as required output | local `REV-SCENE-GEN-04/07` |
...
| `REV-SCENE-GEN-04` | Multi-view cancellation | No new `主体ID-主体名称-多视图` asset or JSON is required, generated, filled, downloaded, or reviewed | `FAIL-SCENE-GEN-04` |
...
| `REV-SCENE-GEN-07` | Visual continuity | Main image preserves one coherent scene identity | `FAIL-SCENE-GEN-07` |
...
| `REV-SCENE-GEN-09` | Reference context | Multi-view reference gate is disabled; missing reference evidence is not a failure | `FAIL-SCENE-GEN-09` |
...
reference_context_status_required_for_multiview: false
