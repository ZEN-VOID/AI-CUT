...
| `运动` | 用户要临摹角色/道具移动、相对位置变化、动作路径和跨画面连续性 | `.agents/skills/aigc/3-运动/SKILL.md + CONTEXT.md`、`references/adaptation-output-contract.md` |
| `摄影` | 用户要临摹镜头语言、运镜、构图、光影、节奏 | `.agents/skills/aigc/4-摄影/SKILL.md + CONTEXT.md`、`references/cinematography-style-analysis-contract.md` |
| `设计` | 用户要临摹角色造型、空镜场景、道具资产、材质和美术秩序 | 按目标加载 `6-设计/角色/2-设计`、`6-设计/场景/2-设计`、`6-设计/道具/2-设计` 与 `references/design-style-analysis-contract.md` |
| `分镜脚本` | 用户要标准表格式分镜脚本或需要对齐 Numbers 示例 | `references/storyboard-script-contract.md`、`templates/output-template.md` |
| `全量输出` | 用户要融合全局风格、编剧、运动、摄影、设计和分镜脚本可套用结果 | 同时加载全局风格、`2-编导`、`3-运动`、`4-摄影`、对应 `6-设计` 子技能和分镜脚本合同 |
