...
node hyperframes-media/scripts/heygen-tts.mjs \
  "Welcome to HyperFrames." -o narration.wav --words narration.words.json

node hyperframes-media/scripts/heygen-tts.mjs ./script.txt -o narration.wav
node hyperframes-media/scripts/heygen-tts.mjs --list   # public starfish voices
```
