...
Canonical structured template: `.agents/skills/aigc/6-设计/角色/2-设计/templates/character_masterprompt.structured.v2.md`
...
| --- | --- | --- | --- | --- |
| 输出结构是否以 `.agents/skills/aigc/6-设计/角色/2-设计/templates/character_masterprompt.structured.v2.md` 为 canonical structured template，而不是由组根模板或脚本生成角色设计正文？ | `GATE-CHAR-DESIGN-14` | `FAIL-CHAR-DESIGN-TEMPLATE-REGISTRY` | `N7-MERGE-DRAFT` | 模板路径、渲染来源、脚本机械边界说明 |
