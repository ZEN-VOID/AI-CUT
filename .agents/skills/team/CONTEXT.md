...
- 未点名人物时，先看任务对象再看风格词：结构问题通常先进小说组，场面先进导演组，表演进演员组，影像进摄影组，空间/服装/美术进设计组，打戏进武术组。
- 当用户索取的是“学者/思想家/方法论视角”，或明确要借某位学者的镜片判断问题时，先走 `study/`，再看是否需要导演组/小说组等创作部门做 side input。
