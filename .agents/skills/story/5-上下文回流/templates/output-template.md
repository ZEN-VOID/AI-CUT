...
- Output format: JSON following `templates/context-return.json`, including `volume_ref`, `chapter_refs`, `validation_ref`, `context_return_delta`, `writeback_summary`, `gate_summary`, and `execution_notes`.
