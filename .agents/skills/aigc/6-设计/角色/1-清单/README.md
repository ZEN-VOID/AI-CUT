...
角色清单 Skill 2.0 包，用于从 `projects/aigc/<项目名>/5-分组/第N集.md` 每个分镜组底部 YAML 的 `角色` 字段生成 canonical 角色清单。
...
- 上游真源：`projects/aigc/<项目名>/5-分组/第N集.md` 的组底 YAML `角色` 字段。
- Canonical 输出：`projects/aigc/<项目名>/6-设计/角色/1-清单/角色清单.md`。
