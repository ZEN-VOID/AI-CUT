...
| 正文已经大体顺了，但仍残留“画面骤碎 / 蒙太奇 / 某角色单独成段报幕” | anti-screenplay module | 先执行 `反镜头说明腔`，把镜头提示改成段落过渡或人物感知 | 把“分镜残留”视为独立清扫对象，而不是混进自然感里模糊带过 | 正文不再像脚本或字幕条 |
...
| 同一画面近邻句重复点名同一人物/物件，像 prompt 展开而不像小说 | adjacent naming residue | 首句保留身份，后句改写为空间落位、动作、视线或身体感 | 终修时把“谁在场”和“他们怎样被放进场里”拆成两类句法职责 | 连续两句不会反复报同一名字 |
...
- 脚本感最重的句子，往往不是差在修辞，而是它根本不承担小说叙事功能，只在替作者喊“切到下一场”。
...
- 若一个人物名字可以整段删掉而不影响理解，说明那一段多半是在报幕而不是在写戏。
