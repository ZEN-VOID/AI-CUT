...
`2-设计` 是 `5-设计` 阶段承接 `1-清单`、连接 `3-面板` 的 tranche parent。
...
| --- | --- | --- | --- |
| `场景` | active | `5-设计/场景/1-清单/第N集/*.json` | `5-设计/场景/2-设计/第N集/` |
| `角色` | active | `5-设计/角色/1-清单/第N集/*.json` | `5-设计/角色/2-设计/第N集/` |
| `服装` | pending-migration | 暂无 active 服装清单 leaf | 暂不声明 active runtime；不得在初始化时预建 `5-设计/服装/*` |
| `道具` | active | `5-设计/道具/1-清单/第N集/*.json` | `5-设计/道具/2-设计/第N集/` |
...
6. `.agents/skills/aigc/5-设计/2-设计/_shared/design-input-contract.md`
7. `.agents/skills/aigc/5-设计/2-设计/_shared/design-output-contract.md`
8. `.agents/skills/aigc/5-设计/2-设计/_shared/design-slot-review-contract.md`
...
11. `.agents/skills/aigc/5-设计/2-设计/_shared/subagent-supervision-contract.md`
...
- 把 `5-设计` 的 post-write 收尾继续挂在 `roles.supervision` 或 `roles.review` 名下，导致审计层与顾问层混线
