...
环境描写：<原文画面句子>
分镜明细：
分镜1: <用自然中文写当前节拍的影视功能、可见主体、动作相位、景别/视角/景深/焦点/镜头类型中的关键变化、运镜方式/速度/停点、构图锚点、光色材质、连续性交接和下游可消费点；只显式写最关键的摄影选择。>
<可选：只有存在第二个真实节拍点时才写 分镜2；若一个镜头已完成观看策略，不补第二镜。关键揭示、动作分相、群像扩散或高点承托可继续写 分镜3/分镜4，但每一镜都必须提供新的观看策略。>
```
