...
description: "Use when creating, rebuilding, repairing, or auditing full-series story character cards, growth states, item hooks, and relationship graphs."
---
...
| --- | --- | --- | --- | --- |
| `C1` | 确认当前真的是角色问题 | `module_route = story-cards > 角色卡` | `FAIL-CD-CHAR-ROUTE` | 回父技能重路由 |
...
- 不得在执行角色卡任务时改写本技能合同、review gate、guardrail 或模板真源。
