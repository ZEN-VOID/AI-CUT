...
def validate(data: dict[str, Any]) -> list[str]:
    ...
    expect(bool(prompt_package.get("positive_prompt")), "prompt_package.positive_prompt is required", errors)
    expect("poster" in str(prompt_package.get("positive_prompt", "")).lower(), "positive_prompt should explicitly mention poster", errors)
