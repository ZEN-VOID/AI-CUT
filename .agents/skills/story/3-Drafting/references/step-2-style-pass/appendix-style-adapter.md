> Canonical module route: `references/step-2-style-pass/module-spec.md`
> 当前角色：Step 2B appendix。根 `SKILL.md` 不再直接路由到本文件。
...
默认字数目标：
- 常规章节默认 2000-2500 字（除非全息地图章节节点或用户另有指定）。
