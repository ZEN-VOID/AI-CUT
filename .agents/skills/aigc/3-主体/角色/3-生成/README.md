...
│   └── legacy-character-generation-workflow.md
├── scripts/
│   └── README.md
├── templates/
...
- `projects/aigc/<项目名>/3-主体/角色/3-生成/<主体ID>-<主体名称>-主图.<ext>`
- `projects/aigc/<项目名>/3-主体/角色/3-生成/<主体ID>-<主体名称>-主图.json`
- `projects/aigc/<项目名>/3-主体/角色/3-生成/<主体ID>-<主体名称>-多视图.<ext>`
- `projects/aigc/<项目名>/3-主体/角色/3-生成/<主体ID>-<主体名称>-多视图.json`
...
- 批量/降级汇流、失败回路和 worker 返回形状已迁入 `SKILL.md` 主脊柱；历史展开保存在 `references/legacy-character-generation-workflow.md`。
