...
| `aesthetic_appeal / charisma_floor` 是否有证据位置，并覆盖来源匹配审美路线、容貌、妆发、骨相、身形、服装吸引力、主角/大反派高魅力下限、真实人物灵感许可与原创转译边界？ | `GATE-CHAR-DESIGN-19` | `FAIL-CHAR-DESIGN-AESTHETIC-APPEAL` | `N7-MERGE-DRAFT` | `aesthetic_appeal`、`charisma_floor` slot evidence map、缺槽 finding |
