...
| `messages_pack` | `projects/story/<项目名>/reports/3-Drafting/deepseek/.../*messages.json` | provider 输入证据 |
| `deepseek_sidecar` | `projects/story/<项目名>/reports/3-Drafting/deepseek/.../` | provider 过程证据 |
