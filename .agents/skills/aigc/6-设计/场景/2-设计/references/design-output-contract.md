...
Canonical structured template: `.agents/skills/aigc/6-设计/场景/2-设计/templates/scene_masterprompt.structured.v2.md`
...
| --- | --- | --- | --- | --- |
| 是否使用 `.agents/skills/aigc/6-设计/场景/2-设计/templates/scene_masterprompt.structured.v2.md` 作为结构真源，而不是另起字段顺序、临时模板或脚本生成正文？ | `GATE-SCENE-DESIGN-05` | `FAIL-SCENE-DESIGN-05` | `N6-DESIGN` | 记录采用的 canonical template、输出 section 顺序、任何字段偏离及其修复位置。 |
