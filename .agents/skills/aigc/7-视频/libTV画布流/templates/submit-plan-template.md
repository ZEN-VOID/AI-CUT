...
episode: 第N集
group_id: x-y-z
group_source_path: projects/aigc/<项目名>/4-分组/第N集.md
...
remote_prompt_template: .agents/skills/aigc/7-视频/libTV画布流/templates/libtv-remote-prompt-template.md
...
- `prompt_body` 只引用 `4-分组` 现有组正文，不在计划中改写剧情事实。
