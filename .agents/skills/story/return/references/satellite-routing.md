...
If a satellite skill discovers that a valid PASS handoff is waiting for actualization, it should point back to `story-return` rather than performing writeback itself.
