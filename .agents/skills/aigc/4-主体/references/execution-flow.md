...
- 阶段根目录：`projects/<项目名>/4-主体/`
- 阶段索引：`projects/<项目名>/4-主体/subject-stage-index.md`
- 阶段验收：`projects/<项目名>/4-主体/validation-report.md`
- 子路径落点：
  - `projects/<项目名>/4-主体/1-清单/`
  - `projects/<项目名>/4-主体/2-设计/`
  - `projects/<项目名>/4-主体/3-审计/`
  - `projects/<项目名>/4-主体/4-面板/`
...
7. 产出统一落在 `projects/<项目名>/4-主体/`，不得散落到其他阶段目录。
...
4. 在 `projects/<项目名>/4-主体/validation-report.md` 写作前后，若 `roles.review.members` 非空，则调用 `评审` 顾问团给出 PASS/返工意见。
