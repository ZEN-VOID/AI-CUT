...
- `projects/<项目名>/4-Design/4-道具/3-面板/第N集/<prop_id>-<prop_name>-PropPanel-layout.json`
- `projects/<项目名>/4-Design/4-道具/3-面板/第N集/_manifest.json`
...
| 载体 | 位置 | 作用 |
| --- | --- | --- |
| design master | `projects/<项目名>/4-Design/4-道具/2-设计/第N集/道具设计.json` | panel 第一输入真源 |
| prompt sidecar | `projects/<项目名>/4-Design/4-道具/2-设计/第N集/prop_design_prompt.json` | 长 prompt、负面约束与渲染提示 |
| layout template | `.agents/skills/aigc/4-Design/4-道具/3-面板/templates/道具面板-提示词.json` | layout contract 真源 |
...
- `actions`
  ...
  3. 锁定输出根为 `4-Design/4-道具/3-面板/第N集/`。
...
- `projects/<项目名>/4-Design/4-道具/3-面板/第N集/` 下的逐 prop layout JSON 与 `_manifest.json`
