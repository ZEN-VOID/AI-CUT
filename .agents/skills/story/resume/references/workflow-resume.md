...
2. `4-Review/第V卷.validation.json`
3. `4-Review/第V卷审查报告.md` + `STATE.json.review_checkpoints`
...
<example>
<input>workflow detect 显示无中断，但项目里已有 `4-Review/第1章.validation.json` 和 `4-Review/第1-1章审查报告.md`，还没有 `5-Loopback/第1章.loopback.json`</input>
<output>
说明：
