...
- deconstruction_coverage: record how every effective identity_pressure, visual_drivers, aesthetic_appeal, charisma_floor, corpus_usage_trace, detailed_character_design, detailed_costume_design and cinematography slot is represented, compressed, merged, or explicitly omitted with reason.
