...
- 变体根目录：`projects/<项目名>/规划/2-格式/解说剧/`
- 主合同：`projects/<项目名>/规划/2-格式/解说剧/格式合同.md`
- 最小样例：`projects/<项目名>/规划/2-格式/解说剧/格式样例.md`
- 局部验收：`projects/<项目名>/规划/2-格式/解说剧/validation-report.md`
