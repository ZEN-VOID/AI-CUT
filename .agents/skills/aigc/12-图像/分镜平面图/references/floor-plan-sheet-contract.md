...
floor_plan_sheet:
  ...
  prompt_block_path: "projects/aigc/<项目名>/12-图像/分镜平面图/第1集/第1集-分镜平面图-prompts.md"
  floor_plan_sheet_path: "projects/aigc/<项目名>/12-图像/分镜平面图/第1集/floor-plan-sheets/1-1-1.png"
...
| 生图未调用、未持久化、越权 fallback，或停在 imagegen plan | `FAIL-FLOOR-IMAGEGEN` | 回到 `N7-IMAGEGEN`，加载并调用 `.agents/skills/cli/imagegen/SKILL.md + CONTEXT.md` |
