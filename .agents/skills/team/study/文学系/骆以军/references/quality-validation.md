...
1. `.agents/skills/aigc/0-初始化/SKILL.md` 缺少 planning interview 的 mandatory 顾问与复核流程 rule
2. `.agents/skills/aigc/_shared/council-runtime/team.template.yaml` 缺少 `require_advisor_review_for_init_interview: true`
