...
旧版 `_shared/` 中出现的 `1-Planning / 2-Global / 3-Detail / 4-Design / 5-Image / 6-Video`，旧中文 `2-编导 / 3-运动 / 4-摄影`，以及 archived `5-表演 / 6-氛围 / 9-光影` 只作为兼容 alias，不应成为新文档的业务真源。

## Dimension Fit

| dimension | current-stage focus |
| --- | --- |
| `规划与种子兑现` | `0-初始化 / 1-分集 / 2-美学 / 3-主体 / 4-编剧` |
| `分镜执行连续性` | `2-美学 / 3-主体 / 4-编剧 / 5-导演 / 6-分镜 / 7-摄影 / 8-分组` |
| `设计对位` | `3-主体 / 8-分组` |
| `图像交付就绪` | `9-图像` |
| `视频交付就绪` | `10-画布` |
...
说明：`3-主体` 同时是技能阶段 owner 与当前项目资产根。旧 `4-设计/` 只作为 transition/compat 输入，review runner 的 required refs 默认读取 `3-主体/`。
