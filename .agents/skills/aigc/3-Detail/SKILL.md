...
- Naming convention: 分镜 ID 使用四段式 `episode-scene-group-frame`，例如 `1-1-1-1`；阶段主文件使用 `第N集.json`；阶段报告固定为 `validation-report.md`；技能包标准文件沿用 `SKILL.md`、`CONTEXT.md`、`README.md`、`CHANGELOG.md`、`TODO.md`。
