...
- 根目录：`projects/<项目名>/主体/2-设计/`
- 角色：
  - `projects/<项目名>/主体/2-设计/角色/第N集/[角色名].md`
  - `projects/<项目名>/主体/2-设计/角色/character_design.json`
- 场景：
  - `projects/<项目名>/主体/2-设计/场景/第N集/[场景名].md`
  - `projects/<项目名>/主体/2-设计/场景/scene_design.json`
- 道具：
  - `projects/<项目名>/主体/2-设计/道具/第N集/[道具名].md`
  - `projects/<项目名>/主体/2-设计/道具/prop_design.json`
- thinking sidecar：
  - `projects/<项目名>/主体/2-设计/thinking/<主体域>/第N集/[主体名].md`
- 验收：`projects/<项目名>/主体/2-设计/validation-report.md`
