...
- 待生成角色的设计文档缺少 `提示词设计`，且用户未允许回到 `角色/2-设计` 修复。
...
| `FIELD-CHAR-GEN-02` | 主图生成 | `<主体名称>-主图` 图片存在，prompt 来自设计文档 `提示词设计` | `FAIL-CHAR-GEN-02` |
| `FIELD-CHAR-GEN-03` | 多视图生成 | `<主体名称>-多视图` 图片存在，reference_image 指向主图 | `FAIL-CHAR-GEN-03` |
