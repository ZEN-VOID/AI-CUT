    ...
    *,
    ...
    return {
        "meta": {
            ...
            "source_design": f"projects/{project_name}/4-Design/3-服装/2-设计/{episode_id}/服装设计.json",
            "source_prompt": f"projects/{project_name}/4-Design/3-服装/2-设计/{episode_id}/costume_design_prompt.json",
        },
        "subject": {
