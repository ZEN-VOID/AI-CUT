...
| `aesthetic_appeal` slot 是否覆盖容貌、妆发、骨相、身形、服装吸引力、主角强化、正反派个性魅力和明星脸原创转译边界？ | `GATE-CHAR-DESIGN-19` | `FAIL-CHAR-DESIGN-AESTHETIC-APPEAL` | `N7-MERGE-DRAFT` | aesthetic slot evidence map、blocking findings |
