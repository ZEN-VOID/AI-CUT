...
本文件承载 `story-drafting-doubao` 的思行网络。节点必须同时表达判断、动作、证据、路由和 gate。
...
| `FAIL-DRAFT-CONTINUITY` | 同卷前文存在但本章开篇像重新开局，或漏接前序事实、位置、线索、关系、道具、卷目标完成度、任务连续性、悬疑节奏、情绪、悬念 | `N3-CONTEXT-PACK`、`N5*` |
