...
```bash
# 结构检查
test -f .agents/skills/aigc/7-设计/场景/2-设计/SKILL.md
test -f .agents/skills/aigc/7-设计/场景/2-设计/CONTEXT.md
find .agents/skills/aigc/7-设计/场景/2-设计 -maxdepth 2 -type f | sort
```
...
- 单场景设计稿：`projects/aigc/<项目名>/7-设计/场景/2-设计/S###-<场景名>.md`
- 可选执行报告：`projects/aigc/<项目名>/7-设计/场景/2-设计/执行报告.md`
