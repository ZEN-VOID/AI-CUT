...
- Normalize `loopback_delta` before opening any truth file for writing.
...
- When a recovery question appears, route to `resume/` even if the next recommendation is to rerun `story-loopback`.
