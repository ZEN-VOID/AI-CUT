...
| slot | answer |
| --- | --- |
| `business_goal` | 从 `6-分组` 组底 YAML `角色` 字段形成后续角色设计可消费的 canonical 清单。 |
| `business_object` | `projects/aigc/<项目名>/6-分组/第N集.md`、分镜组 ID、YAML `角色` 原值、同组正文证据。 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `N1-INTAKE` | 项目路径、集号范围、上游文件 | 是否可定位 `6-分组/第N集.md` | 锁定输入 manifest | 文件路径、集号范围、项目上下文加载记录 | `input_manifest` | `N2-YAML-SCAN` | 上游文件可读 |
