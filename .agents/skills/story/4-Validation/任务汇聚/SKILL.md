---
name: story-validation-task-convergence
description: Use when `4-Validation` needs the governed child skill that checks whether volume/chapter branch tasks remain subordinate to upstream main tasks and converge, transfer, or stay open explicitly.
