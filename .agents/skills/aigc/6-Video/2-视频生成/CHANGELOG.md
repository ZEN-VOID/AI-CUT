...
本文件记录 `aigc/6-Video/2-视频生成` 的结构性改动，不参与默认预加载。

## 2026-04-12

- `Case-20260412-AIGC-VIDEO-GENERATION-SINGLE-SOURCE-UPLIFT`
  - 将 `2-视频生成` 从“主合同摘要 + references 细则”升格为单一 `SKILL.md` 规范真源。
  ...
  - 证据路径：
    ...
    - `.agents/skills/aigc/6-Video/2-视频生成/agents/openai.yaml`
    - `.agents/skills/aigc/6-Video/2-视频生成/providers/README.md`

- `Case-20260412-AIGC-VIDEO-GENERATION-PATH-NORMALIZATION`
  - 将本叶子的当前路径口径统一收敛到 `.agents/skills/aigc/6-Video/2-视频生成/`，清理旧 `3-视频生成` / `subtypes/3-视频生成` 回指。
