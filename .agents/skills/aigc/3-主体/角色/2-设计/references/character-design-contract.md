...
| `costume_craft` | 服饰的剪裁、织物、工艺、闭合方式、层次和服装状态/维护状态是什么？ | 写入 `Detailed Costume Design`，并压缩进英文 prompt 的服装短语；使用痕迹只作条件子类 |
| `body_posture` | 身体比例、重心、肌肉记忆、职业姿态和情绪防御如何呈现？ | 写入 `Detailed Character Design / Body`、`Cinematography` 和 prompt 姿态 |
| `aesthetic_appeal` | 这个角色如何从清单关键词提升为有辨识度、有镜头魅力的主体？审美路线是否匹配清单证据、年龄、性别/性别表达、身份、物种/族群、项目调性和角色权重？主角/大反派是否具备 `charisma_floor=high` 的可见镜头魅力证据？真实人物灵感是否获允许且只作原创转译？ | 写入 `Visual Drivers`、`Detailed Character Design / Face`、`Detailed Costume Design` 和 prompt 审美短语 |
...
- 审美吸引力必须转成具体可见设计：脸型、骨相、五官、眼神、妆发、身形比例、服装廓形、材质、配色、层次和镜头气质。不得只写“好看”“帅”“高级”，也不得把性别化美/帅词当作默认路线。
- 审美路线必须匹配清单证据、年龄、性别/性别表达、身份、物种/族群、项目调性和角色权重；美丽、英俊、清癯、粗粝、威严、危险、阴郁、病态、怪诞、质朴或平凡但可识别都可以成立。主角、核心情感线角色、长期复用角色、大反派、主要对抗者、长线威胁和终局 Boss 必须具备 `charisma_floor=high` 的可见证据，证据必须落在脸部骨相、眼神、妆发、身形、姿态、服装 signature、材质秩序或镜头气场中，但不得强行成人化、性化、美化或帅化。
...
| `2-美学/画面基调/全局风格协议.md` 的 `Global Style Prompt`、当前集优先/项目级回退的 `2-美学/角色风格/角色风格协议.md` 的 `Character Style Prompt`、`north_star.yaml` 的主题/时代/地域/禁区和视觉约束是否被读取；字段漂移、fallback 或缺失是否明确报告，而非虚构风格？ | `GATE-CHAR-DESIGN-03` | `FAIL-NO-STYLE` | `N2-PROJECT-CONTEXT` | `project_design_context`、已消费字段清单、缺失字段说明 |
...
| 容貌、妆发、骨相、身形和服装是否具备来源匹配的审美吸引力；审美路线是否与清单证据、年龄、性别/性别表达、身份、物种/族群、项目调性和角色权重相容；主角、核心情感线角色、长期复用角色、大反派、主要对抗者、长线威胁和终局 Boss 是否具备 `charisma_floor=high` 的可见镜头魅力证据；普通正反派是否都有个性化魅力或清晰可识别度；真实人物灵感是否获允许并原创转译？ | `GATE-CHAR-DESIGN-19` | `FAIL-CHAR-DESIGN-AESTHETIC-APPEAL` | `N7-MERGE-DRAFT` | `aesthetic_appeal_evidence`、来源匹配审美目标、`Charisma Floor`、脸部骨相策略、服装吸引力策略、真实人物灵感原创转译说明 |
