...
def test_planning_paths_default_volume_mapping():
    ...
    assert canonical_chapter_plan_relpath(12) == "2-Planning/第2卷/第12章.md"
...
def test_planning_paths_respect_state_volume_override(tmp_path):
    ...
    assert canonical_chapter_plan_relpath(12, project_root=project_root) == "2-Planning/第1卷/第12章.md"
    assert canonical_chapter_plan_actualization_relpath(12, project_root=project_root) == (
        "2-Planning/第1卷/第12章.actualization.json"
    )
