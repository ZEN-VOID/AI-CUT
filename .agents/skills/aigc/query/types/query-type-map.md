...
| `stage_scope` | `0-初始化`、`1-分集`、`2-编导`、`3-运动`、`4-摄影`、`5-分组`、`6-设计`、`7-图像`、`8-视频`、`9-审片`、`legacy` |
...
| 第N集、分集、编导稿、运动强化稿、摄影稿、分组稿 | `stage_output` | `1-分集`、`2-编导`、`3-运动`、`4-摄影`、`5-分组` | 是否补查执行报告 |
| 角色、场景、道具、主体、设计资产 | `subject_asset` | `6-设计/` | 是否说明清单/设计/生成层级 |
| 分镜画面、故事板、视频、参照视频、审片报告 | `media_asset` | `7-图像/`、`8-视频/A-分镜画面参照/`、`8-视频/B-分镜故事板参照/`、`8-视频/C-主体参照/`、`8-视频/D-主板混合参照/`、`9-审片/` | 是否说明 provider 输出、阶段工件与审片结论差别 |
...
| `3-运动` | `3-运动/第N集.md` | none |
| `4-摄影` | `4-摄影/第N集.md` | none |
| `5-分组` | `5-分组/第N集.md` | none |
| `6-设计` | `6-设计/{场景,角色,道具}/` | `4-Design/` |
| `7-图像` | `7-图像/` | `5-Image/` |
| `8-视频` | `8-视频/{A-分镜画面参照,B-分镜故事板参照,C-主体参照,D-主板混合参照}/` | `6-Video/`、`7-Cut/` |
| `9-审片` | `9-审片/` | none |
