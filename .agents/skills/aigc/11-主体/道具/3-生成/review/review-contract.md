...
| `REV-PROP-GEN-05` | 项目资产、JSON 证据链和持久化路径完整，所有最终输出位于项目 `11-主体/道具/3-生成/` | `FAIL-PROP-GEN-PERSISTENCE` | `N4-MAIN-IMAGE` |
...
| `REV-PROP-GEN-05` | 路径 | 所有项目资产落入 `projects/aigc/<项目名>/11-主体/道具/3-生成/` | `$imagegen` persistence gate |
