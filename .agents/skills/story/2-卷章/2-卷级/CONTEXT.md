...
4. 若章级无法继承中波职责，补 `volume_orchestration_map`，先写 `chapter_payoff_map / chapter_intensity_map / respite_chapters / pressure_chapters / handoff_to_chapter_level`。
5. 若任务线漂成支线列表，强制补 `上承部级主任务 / 主线 / 支线 / 支流角色 / 下钻章级任务分配 / 汇聚回主线`。
