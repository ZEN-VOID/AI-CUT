...
10. 章级 `本章节奏曲线` 必须显式锁 `selected_pack / selected_mode / mode_selection_reason / payoff_type / rhythm_intensity / previous_next_contrast / 七步职责映射 / 规划义务 / 义务段位 / 建议写法`，不得只留一个自然语言段落让 drafting 二次猜测。
...
4. `python3 .agents/skills/story/2-卷章/scripts/validate_planning_outputs.py --help` 可执行。
