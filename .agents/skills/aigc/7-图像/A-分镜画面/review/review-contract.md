...
| --- | --- | --- | --- |
| `G1-SOURCE` | 每个 `shot_id` 可回指 `5-分组` 源组、`source_camera_units`、`frame_landing_type` 与 `frame_landing_reason`；最后一段不是直接继承上游 `分镜N` | `FAIL-FRAME-ID` | `references/group-source-extraction.md` |
