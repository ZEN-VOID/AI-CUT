#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Run the role list pipeline for 4-Design/角色."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", help="输出目录；默认推断到 `projects/aigc/<项目名>/4-Design/`")
...
def resolve_output_dir(input_path: Path, explicit: Optional[str]) -> Path:
    ...
    try:
        ...
        return project_root / "4-Design"
    except ValueError:
        pass

    return input_path.parent / "4-Design"
