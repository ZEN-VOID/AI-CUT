...
class IndexManager(IndexChapterMixin, IndexEntityMixin, IndexDebtMixin, IndexReadingMixin, IndexObservabilityMixin):
        ...
        with self._get_conn() as conn:
            ...
            cursor.execute("""
                CREATE TABLE IF NOT EXISTS review_metrics (
                    ...
                    anti_ai_force_check TEXT DEFAULT 'pending',
    ...
    def _ensure_table_columns(self, cursor, table_name: str, expected_columns: Dict[str, str]) -> None:
        """为旧库补齐新增列。"""
...
def main():
    ...
    # ==================== v5.4 无效事实命令处理 ====================
        ...
        metrics = ReviewMetrics(
            ...
            anti_ai_force_check=data.get("anti_ai_force_check", "pending"),
