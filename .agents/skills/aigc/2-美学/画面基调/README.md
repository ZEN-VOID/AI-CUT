...
- 输入：`projects/aigc/<项目名>/1-分集/第N集.md`、整季 `1-分集/`、项目设定、用户文本、参考图或参考视频。
- 输出：始终为项目级 singleton `projects/aigc/<项目名>/2-美学/画面基调/全局风格协议.md`；单集来源只作为样本范围，不创建 `2-美学/第N集/画面基调/`。
- 报告：正式写回时同步生成 `projects/aigc/<项目名>/2-美学/画面基调/执行报告.md`。
