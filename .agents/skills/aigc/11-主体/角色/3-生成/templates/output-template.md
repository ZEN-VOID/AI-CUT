...
output_root: `projects/aigc/<项目名>/11-主体/角色/3-生成/`
...
| 主体ID | 主体名称 | 主图 | 主图 JSON | 多视图 | 多视图 JSON |
| --- | --- | --- | --- | --- | --- |
| {{主体ID}} | {{主体名称}} | {{main_image_path}} | {{main_prompt_json_path}} | {{multiview_image_path}} | {{multiview_prompt_json_path}} |
...
| Output path | Canonical 路径为 `projects/aigc/<项目名>/11-主体/角色/3-生成/`。 |
