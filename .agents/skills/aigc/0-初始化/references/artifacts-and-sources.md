...
4. `全局风格` must not contain fields that pollute downstream design types, such as shot detail, character material, scene composition, costume details, prop details, or any single-domain style payload.
