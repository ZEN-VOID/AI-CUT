...
CHECKPOINT_REQUIREMENTS = {
    ...
    "episode-split-ready": {
        ...
        "handoff_candidate_refs": ["2-美学/"],
    },
    "aesthetic-ready": {
        "validation_refs": ["2-美学/validation-report.md"],
        "source_truth_refs": [
            "1-分集/{scope_ref}.md",
            "2-美学/类型风格.md",
            "2-美学/",
        ],
        "runtime_artifact_refs": ["2-美学/类型风格.md", "2-美学/"],
        "handoff_candidate_refs": ["3-主体/"],
    },
    "design-ready": {
        "validation_refs": ["3-主体/validation-report.md"],
        "source_truth_refs": [
            "1-分集/",
            "2-美学/类型风格.md",
            "2-美学/画面基调/全局风格协议.md",
            "3-主体/主体注册表.md",
            "3-主体/subject-registry.yaml",
        ],
        "runtime_artifact_refs": ["3-主体/", "3-主体/subject-registry.yaml"],
        "handoff_candidate_refs": ["4-编剧/", "8-分组/", "9-图像/"],
    },
    "screenwriting-ready": {
        "validation_refs": ["4-编剧/validation-report.md"],
        "source_truth_refs": [
            "1-分集/{scope_ref}.md",
            "2-美学/类型风格.md",
            "3-主体/主体注册表.md",
        ...
        "runtime_artifact_refs": ["4-编剧/{scope_ref}.md"],
        "handoff_candidate_refs": ["5-导演/"],
    },
    "director-ready": {
        "validation_refs": ["5-导演/validation-report.md"],
        "source_truth_refs": [
            "4-编剧/{scope_ref}.md",
            "2-美学/",
            "5-导演/{scope_ref}.md",
        ],
        "runtime_artifact_refs": ["5-导演/{scope_ref}.md"],
        "handoff_candidate_refs": ["6-分镜/"],
    },
    "storyboard-ready": {
        "validation_refs": ["6-分镜/validation-report.md"],
        "source_truth_refs": [
            "5-导演/{scope_ref}.md",
            "6-分镜/{scope_ref}.md",
        ],
        "runtime_artifact_refs": ["6-分镜/{scope_ref}.md"],
        "handoff_candidate_refs": ["7-摄影/"],
    },
    "cinematography-ready": {
        "validation_refs": ["7-摄影/validation-report.md"],
        "source_truth_refs": [
            "6-分镜/{scope_ref}.md",
            "7-摄影/{scope_ref}.md",
        ],
        "runtime_artifact_refs": ["7-摄影/{scope_ref}.md"],
        "handoff_candidate_refs": ["8-分组/"],
    },
    "grouping-ready": {
        "validation_refs": ["8-分组/validation-report.md"],
        "source_truth_refs": [
            "7-摄影/{scope_ref}.md",
            "3-主体/subject-registry.yaml",
            "8-分组/{scope_ref}.md",
        ],
        "runtime_artifact_refs": ["8-分组/{scope_ref}.md"],
        "handoff_candidate_refs": ["9-图像/", "10-画布/"],
    },
    "image-request-ready": {
        "validation_refs": ["9-图像/validation-report.md", "8-分组/validation-report.md"],
        "source_truth_refs": [
            "8-分组/{scope_ref}.md",
            "9-图像/分镜画面/",
        ],
        "runtime_artifact_refs": ["9-图像/分镜画面/"],
        "handoff_candidate_refs": ["9-图像/分镜故事板/"],
    },
    "image-storyboard-ready": {
        "validation_refs": ["9-图像/validation-report.md"],
        "source_truth_refs": [
            "8-分组/",
            "3-主体/",
            "9-图像/分镜故事板/",
        ],
        "runtime_artifact_refs": ["9-图像/分镜故事板/"],
        "handoff_candidate_refs": ["10-画布/分镜故事板参照/"],
    },
    "image-handoff-ready": {
        "validation_refs": ["9-图像/validation-report.md"],
        "source_truth_refs": [
        ...
        "runtime_artifact_refs": ["9-图像/"],
        "handoff_candidate_refs": ["Assets/", "10-画布/"],
    },
    "video-request-ready": {
        "validation_refs": ["10-画布/validation-report.md", "8-分组/validation-report.md"],
        "source_truth_refs": [
            "8-分组/{scope_ref}.md",
            "9-图像/分镜故事板/",
            "10-画布/C-主体参照/",
        ],
        "runtime_artifact_refs": ["10-画布/分镜故事板参照/"],
        "handoff_candidate_refs": ["10-画布/C-主体参照/"],
    },
    "video-subject-reference-ready": {
        "validation_refs": ["10-画布/validation-report.md"],
        "source_truth_refs": [
            "3-主体/",
            "9-图像/",
            "10-画布/C-主体参照/",
        ],
        "runtime_artifact_refs": ["10-画布/C-主体参照/"],
        "handoff_candidate_refs": ["10-画布/C-主体参照/"],
    },
    "video-handoff-ready": {
        "validation_refs": ["10-画布/validation-report.md"],
        ...
        "runtime_artifact_refs": ["10-画布/C-主体参照/"],
        "handoff_candidate_refs": ["Assets/", "10-画布/C-主体参照/"],
    },
    "package-release-ready": {
        "validation_refs": [
            "1-分集/validation-report.md",
            "2-美学/validation-report.md",
            "3-主体/validation-report.md",
            "4-编剧/validation-report.md",
            "5-导演/validation-report.md",
            "6-分镜/validation-report.md",
            "7-摄影/validation-report.md",
            "8-分组/validation-report.md",
            "9-图像/validation-report.md",
            "10-画布/validation-report.md",
        ],
        "source_truth_refs": [
            "MEMORY.md",
            "1-分集/",
...
STAGE_REQUIREMENTS = {
    ...
    "2-美学": CHECKPOINT_REQUIREMENTS["aesthetic-ready"],
    "3-主体": CHECKPOINT_REQUIREMENTS["design-ready"],
    "4-编剧": CHECKPOINT_REQUIREMENTS["screenwriting-ready"],
    "5-导演": CHECKPOINT_REQUIREMENTS["director-ready"],
    "6-分镜": CHECKPOINT_REQUIREMENTS["storyboard-ready"],
    "7-摄影": CHECKPOINT_REQUIREMENTS["cinematography-ready"],
    "8-分组": CHECKPOINT_REQUIREMENTS["grouping-ready"],
    "9-图像": {
        "validation_refs": ["9-图像/validation-report.md"],
        "source_truth_refs": ["3-主体/", "8-分组/", "9-图像/"],
        "runtime_artifact_refs": ["9-图像/"],
        "handoff_candidate_refs": ["10-画布/", "Assets/"],
    },
    "10-画布": {
        "validation_refs": ["10-画布/validation-report.md"],
        "source_truth_refs": ["9-图像/", "10-画布/"],
        "runtime_artifact_refs": ["10-画布/"],
        "handoff_candidate_refs": ["Assets/", "validation-report.md"],
    },
}
...
DIMENSION_EXPECTATIONS = {
    "planning-seed-validator": {
        "source_prefixes": ["MEMORY.md", "0-初始化/", "1-分集/", "2-美学/", "3-主体/", "4-编剧/"],
        "validation_prefixes": ["0-初始化/", "1-分集/", "2-美学/", "3-主体/", "4-编剧/"],
    },
    "detail-execution-validator": {
        "source_prefixes": ["2-美学/", "3-主体/", "4-编剧/", "5-导演/", "6-分镜/", "7-摄影/", "8-分组/"],
        "runtime_prefixes": ["5-导演/", "6-分镜/", "7-摄影/", "8-分组/"],
        "validation_prefixes": ["2-美学/", "3-主体/", "4-编剧/", "5-导演/", "6-分镜/", "7-摄影/", "8-分组/"],
    },
    "design-alignment-validator": {
        "source_prefixes": ["3-主体/", "8-分组/"],
        "runtime_prefixes": ["3-主体/"],
        "validation_prefixes": ["3-主体/"],
    },
    "image-delivery-validator": {
        "source_prefixes": ["3-主体/", "8-分组/", "9-图像/"],
        "runtime_prefixes": ["9-图像/"],
        "validation_prefixes": ["9-图像/"],
    },
    "video-delivery-validator": {
        "source_prefixes": ["3-主体/", "8-分组/", "9-图像/", "10-画布/"],
        "runtime_prefixes": ["10-画布/"],
        "validation_prefixes": ["10-画布/"],
    },
