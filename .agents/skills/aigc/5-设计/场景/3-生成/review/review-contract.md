...
| `REV-SCENE-GEN-03` | Main image | `主体名称-主图` exists under project `3-生成` | `FAIL-SCENE-GEN-03` |
| `REV-SCENE-GEN-04` | Multi-view image | `主体名称-多视图` exists and used main image as reference | `FAIL-SCENE-GEN-04` |
| `REV-SCENE-GEN-05` | JSON records | Each image has same-name JSON with source, prompt, mode, path, review | `FAIL-SCENE-GEN-05` |
