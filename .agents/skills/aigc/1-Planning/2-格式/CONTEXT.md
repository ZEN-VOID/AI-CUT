...
- 调用 `.agents/skills/aigc/1-Planning/2-格式/SKILL.md` 时，应自动预加载本文件。
...
| --- | --- | --- | --- | --- |
| 又把 `格式判模 / 标准剧 / 解说剧` 拆成外部 agent 依赖 | 真源治理层 | 收回到 `2-格式/SKILL.md` 的内化能力面 | 在 `SKILL.md + audit` 固化 `Internal Capability Fusion Contract` | `2-格式` 不再引用旧规划组文档 |
