...
3. 锁定综合色板、冷暖关系、饱和与明度节奏，并回查已存在的光影与氛围约束。
4. 仅生成本镜级 `摄影美学` 字段中的色彩 patch，不越权改写其他 sibling 字段。
