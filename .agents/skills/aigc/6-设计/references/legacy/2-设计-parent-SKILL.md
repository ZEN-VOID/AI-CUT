...
description: Use when `6-设计/2-设计` needs to consume `1-清单` design-source JSON plus `0-Init` and `2-Global` truths, then route the current design work under `projects/aigc/<项目名>/6-设计/` for downstream `3-面板`.
...
`2-设计` 是 `6-设计` 阶段承接 `1-清单`、连接 `3-面板` 的 tranche parent。
...
| --- | --- | --- | --- |
| `场景` | active | `6-设计/场景/1-清单/第N集/*.json` | `6-设计/场景/2-设计/第N集/` |
| `角色` | active | `6-设计/角色/1-清单/第N集/*.json` | `6-设计/角色/2-设计/第N集/` |
| `服装` | pending-migration | 暂无 active 服装清单 leaf | 暂不声明 active runtime；不得在初始化时预建 `6-设计/服装/*` |
| `道具` | active | `6-设计/道具/1-清单/第N集/*.json` | `6-设计/道具/2-设计/第N集/` |

## Shared Canonical Sources (Mandatory)

- `.agents/skills/aigc/6-设计/SKILL.md`
- `.agents/skills/aigc/_shared/project-runtime-layout.md`
- `.agents/skills/aigc/_shared/council-runtime/module-spec.md`
- `.agents/skills/aigc/6-设计/1-清单/SKILL.md`
- `.agents/skills/aigc/6-设计/2-设计/_shared/design-input-contract.md`
- `.agents/skills/aigc/6-设计/2-设计/_shared/design-output-contract.md`
- `.agents/skills/aigc/6-设计/2-设计/_shared/design-slot-review-contract.md`
- `.agents/skills/aigc/6-设计/2-设计/_shared/workflow-supervision-contract.md`
...
4. `.agents/skills/aigc/6-设计/1-清单/SKILL.md + CONTEXT.md`
5. 本 `SKILL.md + CONTEXT.md`
6. `.agents/skills/aigc/6-设计/2-设计/_shared/design-input-contract.md`
7. `.agents/skills/aigc/6-设计/2-设计/_shared/design-output-contract.md`
8. `.agents/skills/aigc/6-设计/2-设计/_shared/design-slot-review-contract.md`
...
11. `.agents/skills/aigc/6-设计/2-设计/_shared/workflow-supervision-contract.md`
...
- 命中 `场景`：`projects/aigc/<项目名>/6-设计/场景/1-清单/第N集/场景清单.json`
- 命中 `角色`：`projects/aigc/<项目名>/6-设计/角色/1-清单/第N集/角色清单.json`
- 命中 `道具`：`projects/aigc/<项目名>/6-设计/道具/1-清单/第N集/道具清单.json`

### 强烈建议输入

- `projects/aigc/<项目名>/6-设计/角色/1-清单/第N集/role_design_bridge.json`
- `projects/aigc/<项目名>/6-设计/角色/1-清单/第N集/角色研究.json`
- `projects/aigc/<项目名>/6-设计/场景/1-清单/第N集/场景研究.json`
- `projects/aigc/<项目名>/6-设计/场景/1-清单/第N集/scene_design_bridge.json`
- `projects/aigc/<项目名>/6-设计/道具/1-清单/第N集/道具研究.json`
- `projects/aigc/<项目名>/6-设计/道具/1-清单/第N集/prop_design_bridge.json`
...
6. 父层阶段摘要只写到 `projects/aigc/<项目名>/6-设计/validation-report.md`。
...
| --- | --- | --- | --- | --- |
| 是否仍把旧 `.agents/skills/aigc/6-设计/2-设计` 当作当前 active 设计入口，而不是路由到 `场景 / 角色 / 道具` 域级 `2-设计` leaf？ | `GATE-DESIGN-LEGACY-01` | `FAIL-DESIGN-LEGACY-ACTIVE-ENTRY` | `D-N2-DOMAIN`；`references/阶段路由矩阵.md` | 旧 tranche 触发词、active domain route、legacy archive 只读声明 |
...
- 把 `6-设计` 的 post-write 收尾继续挂在 `roles.supervision` 或 `roles.review` 名下，导致审计层与顾问层混线
