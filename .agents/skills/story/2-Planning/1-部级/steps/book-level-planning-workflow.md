...
| `business_object` | `2-Planning/整体规划.md`、`north_star.yaml`、`init_handoff.yaml`、`类型卡`、项目记忆。 |
...
| --- | --- | --- | --- | --- | --- | --- |
| `N1-INPUT-LOCK` | 锁定立项输入与题材方向 | `0-Init`、类型卡、项目 `MEMORY.md`、父层合同 | 读取输入，确认读者承诺、题材禁区和已有规划状态 | 输入清单与 mode | `N2-TITLE-PROMISE` | 输入面明确 |
