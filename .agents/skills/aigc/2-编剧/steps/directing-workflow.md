...
| `constraint_profile` | 原文信息量保真、对白冻结、长对白节拍拆分、声画配对、slugline 稳定、小说表述二次画面化、主角内心独白保留、动作客观可拍、关键面部 beat 有 `表情特写` 或相邻字段承托、环境字段纯化、环境氛围承托、LLM-first、顾问与复核流程 监制顾问上下文沉淀 |
