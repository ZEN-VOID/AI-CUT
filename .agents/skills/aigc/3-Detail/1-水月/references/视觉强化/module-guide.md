...
- 它不是单独写美术设定，而是对现有组级 prose 做视觉收益增强，让下游模型更容易抓到焦点、质感和节奏。
...
| `V5 汇流裁剪` | 最终该留下哪组视觉收益 | 只保留一个主抓手和少量必要反差 | 单一 `visual_patch` | 贪多，导致 prose 发闷 |
...
- 若 `visual_patch` 已经像独立美术设定，说明越权了；应回到“为当前 prose 增益”而不是另起炉灶。
