...
```bash
python3 /Users/vincentlee/.codex/skills/meta/构建/技能/skill-工作车间/scripts/validate_skill_2_0.py .agents/skills/story/2-卷章/1-部级 --mode delivery
python3 /Users/vincentlee/.codex/skills/meta/构建/技能/skill-工作车间/scripts/smoke_test_skill_2_0.py .agents/skills/story/2-卷章/1-部级 --mode delivery
