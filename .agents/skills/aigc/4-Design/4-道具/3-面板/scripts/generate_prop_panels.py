    ...
    *,
    ...
    return {
        "meta": {
            ...
            "source_design": f"projects/{project_name}/4-Design/4-道具/2-设计/{episode_id}/道具设计.json",
            "source_prompt": f"projects/{project_name}/4-Design/4-道具/2-设计/{episode_id}/prop_design_prompt.json",
        },
        "subject": {
            "prop_id": prop_id,
...
def main() -> int:
    parser = argparse.ArgumentParser(description="从 4-Design/4-道具/2-设计 生成逐道具 panel layout JSON。")
