...
| 反常规规则是否至少能映射到一个长期约束、开篇钩子或 planning unknown，而不是孤立口号？ | `creative_seed` / `handoff` | `FAIL-INIT-HANDOFF` | 本文件约束设计段、`SKILL.md` N6B-N7 | hard_constraints patch、opening_hook notes |
