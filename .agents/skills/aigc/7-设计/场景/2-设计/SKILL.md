...
- 已存在的 `projects/aigc/<项目名>/7-设计/场景/1-清单/场景清单.md`。
...
- 可读取的 `7-设计/场景/1-清单/场景清单.md`，且至少包含 `名称`、`首次登场`、`原文描述（关键词式）` 三列。
...
| --- | --- |
| `OUTPUT-SCENE-DESIGN` | `projects/aigc/<项目名>/7-设计/场景/2-设计/S###-<场景名>.md` |
| `OUTPUT-SCENE-DESIGN-REPORT` | `projects/aigc/<项目名>/7-设计/场景/2-设计/执行报告.md` |
