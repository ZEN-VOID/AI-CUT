...
```
已保存到 input/番茄小说/7399487167648500798/metadata.json
共 256 章
...
```
使用已有目录: input/番茄小说/7399487167648500798/metadata.json
共 256 章需要下载
...
print(f"保存到: {path}")  # input/番茄小说/7399487167648500798/metadata.json
```
