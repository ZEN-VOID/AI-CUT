...
本文件是 `aigc/4-Design/3-服装/2-设计` 的输入输出、命名与 handoff 单一真源。

## Inputs

| 类型 | 路径 | 作用 |
| --- | --- | --- |
| 必需 | `projects/<项目名>/4-Design/3-服装/1-清单/第N集/costume_design_bridge.json` | 当前集服装桥接主输入 |
| 必需 | `projects/<项目名>/4-Design/3-服装/1-清单/第N集/服装研究.json` | 研究层证据与结论 |
| 必需 | `projects/<项目名>/4-Design/3-服装/1-清单/第N集/服装清单.json` | 当前集服装对象池 |
| 可选 | `projects/<项目名>/4-Design/2-角色/2-设计/第N集/character_design.json` | 角色锚点与角色兼容约束 |
...
| 可选 | `projects/<项目名>/4-Design/3-服装/2-设计/第N集/*` | 已有服装设计稿，供增量 patch 使用 |

## Outputs

| 类型 | 路径 | 责任 |
| --- | --- | --- |
| canonical | `projects/<项目名>/4-Design/3-服装/2-设计/第N集/服装设计.json` | machine-first 服装设计主稿 |
| canonical | `projects/<项目名>/4-Design/3-服装/2-设计/第N集/<costume_id>-<canonical_label>.md` | 与 JSON 同源的人读稿 |
| canonical | `projects/<项目名>/4-Design/3-服装/2-设计/第N集/costume_design_prompt.json` | prompt sidecar |
| canonical | `projects/<项目名>/4-Design/3-服装/2-设计/第N集/_manifest.json` | 本轮输入、命中服装、输出清单与审计摘要 |
