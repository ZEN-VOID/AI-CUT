...
3.08. 检查真人角色是否被简化成情绪表情包：如果只剩开心、生气、害怕、发呆等明确情绪，补上表层情绪、压制情绪、隐藏动机、未出口信息和身体泄露点；非人/机器角色可按项目设定例外处理。
...
- 真人角色最复杂的是没说出口的东西。笑、发呆、吃饭、停顿这类表层动作必须追到上游压力和压制动机；只给几个明确情绪，通常只适合低复杂度非人角色或风格化角色。
