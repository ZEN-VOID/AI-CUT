...
output_dir: `projects/aigc/<项目名>/11-主体/道具/3-生成`

## 生成资产

| 主体ID | 主体 | 上游设计文档 | 主图 | 主图 JSON | 多视图 | 多视图 JSON | reference_context_status | verdict |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `<主体ID>` | `<主体名称>` | `11-主体/道具/2-设计/<主体名称>.md` | `<主体ID>-<主体名称>-主图.png` | `<主体ID>-<主体名称>-主图.json` | `<主体ID>-<主体名称>-多视图.png` | `<主体ID>-<主体名称>-多视图.json` | `visible_in_conversation_context` | `pending` |
...
| Output path | canonical path 为 `projects/aigc/<项目名>/11-主体/道具/3-生成/`。 |
