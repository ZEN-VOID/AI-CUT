...
| 查找路径是否只落在角色、场景、道具三个 `6-设计/*/3-生成` 目录，没有扫描项目其他位置凑图？ | `G6-SLOTS` | `FAIL-SHEET-REF` | `N5-REF-BIND` / `references/reference-slot-binding.md#search-roots` | manifest 记录 search roots、候选路径和未越界扫描说明 |
