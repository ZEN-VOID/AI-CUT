...
| --- | --- | --- | --- | --- |
| `TXT-N1-DIRECTION` | 回收质感方向 | 质感应该往哪个方向收，不能往哪个方向跑 | 从 `visual_control_line` 提炼当前组的 `texture_direction` | `texture_direction` |
| `TXT-N2-FOCUS` | 锁材料焦点 | 观众最先会感到什么材料 | 指定 1 到 2 个主材料焦点 | `material_focus` |
| `TXT-N3-BEHAVIOR` | 锁表面行为 | 材料是如何被镜头感知的 | 写表面反光、潮湿、粗糙、颗粒等行为 | `surface_behavior` |
| `TXT-N4-GAIN` | 锁触感收益 | 这些材料感如何服务空间、人物或情绪 | 说明触感收益与世界表面语言 | `tactile_gain` |
| `TXT-N5-RESTRAINT` | 锁节制边界 | 哪些材料信息应该被收掉 | 标出应删减的次级材质或装饰性描写 | `texture_restraint` |
