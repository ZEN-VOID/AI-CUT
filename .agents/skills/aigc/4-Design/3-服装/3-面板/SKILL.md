...
6. `projects/<项目名>/4-Design/3-服装/2-设计/第N集/服装设计.json`
7. `projects/<项目名>/4-Design/3-服装/2-设计/第N集/costume_design_prompt.json`
...
| `DL3` | 输出根是否正确 | 锁 `projects/<项目名>/4-Design/3-服装/3-面板/第N集/` | 不得漂移到 `2-设计` 目录 |
...
1. `projects/<项目名>/4-Design/3-服装/3-面板/第N集/<costume_id>-<canonical_label>-CostumePanel-layout.json`
2. `projects/<项目名>/4-Design/3-服装/3-面板/第N集/_manifest.json`
