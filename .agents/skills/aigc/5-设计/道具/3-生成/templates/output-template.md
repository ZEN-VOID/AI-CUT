...
| 主体ID | 主体 | 上游设计文档 | 主图 | 主图 JSON | 多视图 | 多视图 JSON | verdict |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `<主体ID>` | `<主体名称>` | `5-设计/道具/2-设计/<主体名称>.md` | `<主体ID>-<主体名称>-主图.png` | `<主体ID>-<主体名称>-主图.json` | `<主体ID>-<主体名称>-多视图.png` | `<主体ID>-<主体名称>-多视图.json` | `pending` |
...
| Completion gate | 每组资产回指上游 `2-设计` 文档，主图引用 `4. 解构`，多视图引用主图，已完成 review verdict。 |
