...
| `templates/output-template.md` | `GATE-SCR-16`, `GATE-SCR-21`, `GATE-SCR-22`, `GATE-SCR-23`, `GATE-SCR-24`, `GATE-SCR-25` | `FAIL-SCR-REPORT`, `FAIL-SCR-TYPE-STYLE-CONTEXT`, `FAIL-SCR-SUBJECT-REGISTRY-CONTEXT`, `FAIL-SCR-UPSTREAM-DIRECTION-MATRIX`, `FAIL-SCR-SCENE-ASSET-CONTEXT`, `FAIL-SCR-SCREENPLAY-MODE`, `FAIL-SCR-JIESHUOJU-FIELD-MONOTONY` | `N8` | `execution_report`, `screenplay_mode_decision`, `jieshuoju_source_unit_coverage_map`, `jieshuoju_field_variety_map`, `type_style_application_map`, `subject_registry_application_map`, `upstream_creative_direction_matrix`, `scene_asset_integration_map` |
