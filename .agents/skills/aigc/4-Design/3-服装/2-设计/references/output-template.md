...
```json
{
  "meta": {
    "project_name": "项目名",
    "episode_id": "第1集",
    "source_bridge": "projects/项目名/4-Design/3-服装/1-清单/第1集/costume_design_bridge.json",
    "skill_id": "aigc/4-Design/3-服装/2-设计",
  ...
  "costumes": [
    {
      ...
      "structured_markdown_path": "projects/项目名/4-Design/3-服装/2-设计/第1集/costume-role-001-baseline-角色名-常服.md"
    }
  ]
}
```
