...
本知识库服务 `.agents/skills/aigc/9-光影/SKILL.md`，用于在逐分镜光影美学注入时提供“可转译为正文的光影表现技巧”。它不是第二执行合同，不拥有输出路径、完成门或主链裁决权；调用时必须回到主入口 `N2-LIGHT-UNDERSTAND`、`N5-LIGHT-SHOT-FUNCTION`、`N6-LIGHT-DESIGN` 和 `N8-LIGHT-REVIEW-REPAIR`。
