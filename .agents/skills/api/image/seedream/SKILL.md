...
-> `规则源`：`.agents/skills/api/image/seedream/SKILL.md` 与 `scripts/seedream_generate.py`
...
- 接口摘要：`.agents/skills/api/image/seedream/references/api.md`
- 官方文档：[Volcengine SEEDREAM 5.0](https://www.volcengine.com/docs/82379/1824121?lang=zh)
- 环境变量源：根目录 `.env`
- 依赖安装：`pip install -r .agents/skills/api/image/seedream/requirements.txt`
