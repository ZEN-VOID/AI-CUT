...
| 续作项目里明明需要旧作底色，起盘却只读当前章 board，导致前情回响全退化成空泛设定摘要 | sequel continuity underload | 回读 `story-source-manifest.yaml` 与 relevant source refs，只取会直接改变当前动作/关系的那一小段 | 在 Step 1 固定“旧事若影响当前选择，必须在首轮正文显影” | 旧作回响会改变人怎么想、怎么躲、怎么护，而不是只长成背景说明 |
| 起盘里残留“画面骤碎 / 蒙太奇 / 某角色独立报幕”这类镜头说明句 | screenplay residue in kickoff | 直接改写成段落过渡、物象过桥或人物感知切换 | 起盘阶段把镜头语法视为未完成的 prose 中间态，而不是可留给终修兜底的小毛刺 | 首轮正文已经是小说句法，不再像分镜脚本 |
...
- 续作 continuity 最怕“知道很多，但此刻没人因此改变动作”；一旦旧事没有改变当前谁敢靠近、谁先闭嘴、谁会护短，它多半还没真正进戏。
