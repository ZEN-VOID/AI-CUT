...
- 自动生成研究考据。
- 自动生成身份、职业、阶层、地域年代、服饰工艺、身体姿态、审美吸引力、禁区、不确定性或 prompt evidence chain 正文。
- 自动选择、套用或扩写 `knowledge-base/character-design-corpus.md` 的角色类型语料、妆容短语、服装时代语境或 prompt 审美短语正文。
