# 5-设计 / 2-设计 / 道具 Shared I/O Contract

本文件是 `aigc/5-设计/道具` 的输入输出、命名与 compat projection 单一辅助真源。

## Inputs

| 类型 | 路径 | 作用 |
| --- | --- | --- |
| 必需 | `projects/aigc/<项目名>/4-设计/道具/1-清单/第N集/道具清单.json` | 本阶段第一输入根 |
...
| 可选 | `projects/aigc/<项目名>/4-设计/道具/1-清单/第N集/道具研究.json` | compat research 补证 |
| 可选 | `projects/aigc/<项目名>/4-设计/道具/1-清单/第N集/prop_design_bridge.json` | compat bridge 补证 |
...
| 类型 | 路径 | 责任 |
| --- | --- | --- |
| canonical | `projects/aigc/<项目名>/4-设计/道具/2-设计/第N集/<prop_id>-<canonical_name>.md` | 逐道具 Markdown 设计卡真源 |
| sidecar | `projects/aigc/<项目名>/4-设计/道具/2-设计/第N集/_manifest.json` | 审计侧车；基础壳固定为 `status / episode_id / input_file / output_dir / output_files / statistics / notes` |
| compat | `projects/aigc/<项目名>/4-设计/道具/2-设计/第N集/道具设计.json` | 旧下游兼容 projection，仅在显式模式下导出 |
| compat | `projects/aigc/<项目名>/4-设计/道具/2-设计/第N集/prop_design_prompt.json` | 旧下游 compat prompt sidecar，仅在显式模式下导出 |
