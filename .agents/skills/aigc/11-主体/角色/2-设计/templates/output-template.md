...
source_character_list: `projects/aigc/<项目名>/11-主体/角色/1-清单/角色清单.md`
...
- Aesthetic Appeal: 强化容貌、妆发、身形和服装的审美完成度；女性角色美丽动人，男性角色英俊不凡，主角更强，正反派和功能角色都要有个性化魅力。明星脸灵感只可作为原创转译参考，不得精确复刻或换脸。
...
- Beauty / Handsomeness Target: {{女性写美丽动人目标，男性写英俊不凡目标；主角进一步强化颜值、气质和服装完成度；非主角写辨识度和个性魅力}}
- Celebrity Face Inspiration: {{可选：1 到 2 个明星/演员/模特的脸型、骨相、眼神、妆发或镜头魅力灵感；必须原创转译，不得精确复刻现实人物；不用真实人物时写 none 或泛化为明星级镜头脸}}
- Design Decision: {{审美目标如何转化为脸型、骨相、五官、妆发、身形比例、服装廓形、材质、配色和整体魅力}}
...
| {{审美吸引力证据}} | {{容貌、骨相、妆发、身形和服装吸引力决策；明星脸灵感如有则说明原创转译}} | {{英文审美短语；不得指向精确复刻现实人物}} |
...
Beauty / Handsomeness Target: {{beauty_handsomeness_target}}
Celebrity Face Inspiration: {{celebrity_face_inspiration_optional_originalized}}
...
- Aesthetic Function: {{说明脸型、骨相、五官和妆发如何服务美丽/英俊/危险魅力/阴郁魅力/怪诞魅力等审美目标，而不是机械还原关键词}}
- Makeup: {{face_makeup}}
