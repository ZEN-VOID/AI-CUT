...
| `N3-CONTEXT-PACK` | 组装写作上下文包 | 三层 planning、global/style cards、`north_star`、`MEMORY.md`、项目 `CONTEXT/`、上一章 | 读取并压缩为 provider 可消费上下文；上一章存在时生成连续性桥 | messages pack、context refs、continuity bridge | `N4-DRAFT-BRANCH` | 必需输入齐备；上一章存在时必须有桥接约束 |
