...
- 本文件是 `.agents/skills/aigc/4-Design/2-角色/3-面板` 的经验层知识库，不是过程日志。
- 调用本叶子技能时，应自动预加载本文件。
...
- outcome: 为 `.agents/skills/aigc/4-Design/2-角色/3-面板` 建立了主合同、经验层、shared I/O、模板、入口元数据与最小 packet 生成脚本。
...
- user_feedback_or_constraint: 用户要求完善当前仓 `.agents/skills/aigc/4-Design/2-角色/3-面板`，并参照 `/Volumes/AIGC/AIGC-ZEN-VOID/.agents/skills/aigc2026/3-设定/4-面板/角色面板`。
...
- evidence_paths:
  ...
  - `.agents/skills/aigc/4-Design/2-角色/3-面板/references/type-strategies.md`
