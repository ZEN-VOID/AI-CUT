...
| `messages_pack` | `projects/story/<项目名>/reports/3-Drafting/doubao/.../*messages.json` | provider 输入证据 |
| `provider_sidecar` | `projects/story/<项目名>/reports/3-Drafting/doubao/.../` | provider 过程证据 |
