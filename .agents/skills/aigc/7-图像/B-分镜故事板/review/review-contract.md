...
本 review gate 只裁决 `B-分镜故事板` 的组级 prompt、主体参照、imagegen 计划与项目持久化，不改写 `5-分组` 主真源。
...
| --- | --- | --- | --- |
| `G1-SOURCE` | 每个 `group_id` 可回指 `5-分组` 源标题、组正文和 YAML | `FAIL-SHEET-GROUP` | `references/group-source-extraction.md` |
