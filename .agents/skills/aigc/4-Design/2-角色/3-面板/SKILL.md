...
`3-面板` 是 `4-Design/2-角色` 下承接 `2-设计` 的角色展示面板叶子技能，负责把：
...
5. `.agents/skills/aigc/4-Design/2-角色/2-设计/SKILL.md + CONTEXT.md`
6. 本 `SKILL.md + CONTEXT.md`
7. `.agents/skills/aigc/4-Design/2-角色/3-面板/_shared/IO_CONTRACT.md`
8. `templates/角色面板-提示词.json`
9. `scripts/build_character_panel_packets.py`
10. `projects/<项目名>/4-Design/2-角色/2-设计/第N集/character_design.json`
11. `projects/<项目名>/4-Design/2-角色/2-设计/第N集/[角色名].md`
12. 可选 `projects/<项目名>/4-Design/2-角色/1-清单/第N集/角色清单.json`

## Shared Canonical Sources (Mandatory)

- 强制读取：`.agents/skills/aigc/4-Design/2-角色/3-面板/_shared/IO_CONTRACT.md`
- 强制读取：`.agents/skills/aigc/4-Design/2-角色/3-面板/templates/角色面板-提示词.json`
- 强制读取：`.agents/skills/aigc/4-Design/2-角色/3-面板/scripts/build_character_panel_packets.py`
...
5. 输出目录固定为 `projects/<项目名>/4-Design/2-角色/3-面板/第N集/`
...
- `.agents/skills/aigc/4-Design/2-角色/3-面板/templates/角色面板-提示词.json`
...
`projects/<项目名>/4-Design/2-角色/3-面板/第N集/<role_id>-<role_name>-<costume_state>-CharacterPanel-layout.json`
...
`projects/<项目名>/4-Design/2-角色/3-面板/第N集/_manifest.json`
