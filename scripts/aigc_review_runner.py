...
CHECKPOINT_REQUIREMENTS = {
    ...
    "directing-script-ready": {
        ...
        "handoff_candidate_refs": ["4-摄影/"],
    },
    "cinematography-ready": {
        "validation_refs": ["4-摄影/validation-report.md"],
        "source_truth_refs": [
            "2-编导/{scope_ref}.md",
            "4-摄影/{scope_ref}.md",
        ],
        "runtime_artifact_refs": ["4-摄影/{scope_ref}.md"],
        "handoff_candidate_refs": ["5-分组/"],
    },
    "grouping-ready": {
        "validation_refs": ["5-分组/validation-report.md"],
        "source_truth_refs": [
            "4-摄影/{scope_ref}.md",
            "5-分组/{scope_ref}.md",
        ],
        "runtime_artifact_refs": ["5-分组/{scope_ref}.md"],
        "handoff_candidate_refs": ["6-设计/"],
    },
    "design-ready": {
        "validation_refs": ["6-设计/validation-report.md"],
        "source_truth_refs": [
            "5-分组/{scope_ref}.md",
            "6-设计/",
        ],
        "runtime_artifact_refs": ["6-设计/"],
        "handoff_candidate_refs": ["7-图像/", "8-视频/"],
    },
    "image-request-ready": {
        "validation_refs": ["7-图像/validation-report.md", "5-分组/validation-report.md"],
        "source_truth_refs": [
            "5-分组/{scope_ref}.md",
            "7-图像/A-分镜画面/",
        ],
        "runtime_artifact_refs": ["7-图像/A-分镜画面/"],
        "handoff_candidate_refs": ["7-图像/B-分镜故事板/"],
    },
    "image-storyboard-ready": {
        "validation_refs": ["7-图像/validation-report.md"],
        "source_truth_refs": [
            "5-分组/",
            "6-设计/",
            "7-图像/B-分镜故事板/",
        ],
        "runtime_artifact_refs": ["7-图像/B-分镜故事板/"],
        "handoff_candidate_refs": ["8-视频/B-分镜故事板参照/"],
    },
    "image-handoff-ready": {
        "validation_refs": ["7-图像/validation-report.md"],
        "source_truth_refs": [
        ...
        "runtime_artifact_refs": ["7-图像/"],
        "handoff_candidate_refs": ["Assets/", "8-视频/"],
    },
    "video-request-ready": {
        "validation_refs": ["8-视频/validation-report.md", "5-分组/validation-report.md"],
        "source_truth_refs": [
            "5-分组/{scope_ref}.md",
            "7-图像/B-分镜故事板/",
            "8-视频/C-主体参照/",
        ],
        "runtime_artifact_refs": ["8-视频/B-分镜故事板参照/"],
        "handoff_candidate_refs": ["8-视频/C-主体参照/"],
    },
    "video-subject-reference-ready": {
        "validation_refs": ["8-视频/validation-report.md"],
        "source_truth_refs": [
            "6-设计/",
            "7-图像/",
            "8-视频/C-主体参照/",
        ],
        "runtime_artifact_refs": ["8-视频/C-主体参照/"],
        "handoff_candidate_refs": ["8-视频/C-主体参照/"],
    },
    "video-handoff-ready": {
        "validation_refs": ["8-视频/validation-report.md"],
        ...
        "runtime_artifact_refs": ["8-视频/C-主体参照/"],
        "handoff_candidate_refs": ["Assets/", "8-视频/C-主体参照/"],
    },
    "package-release-ready": {
        "validation_refs": [
            "1-分集/validation-report.md",
            "2-编导/validation-report.md",
            "4-摄影/validation-report.md",
            "5-分组/validation-report.md",
            "6-设计/validation-report.md",
            "7-图像/validation-report.md",
            "8-视频/validation-report.md",
        ],
        "source_truth_refs": [
            "0-初始化/north_star.yaml",
            "1-分集/",
...
STAGE_REQUIREMENTS = {
    ...
    "4-摄影": CHECKPOINT_REQUIREMENTS["cinematography-ready"],
    "5-分组": CHECKPOINT_REQUIREMENTS["grouping-ready"],
    "6-设计": CHECKPOINT_REQUIREMENTS["design-ready"],
    "7-图像": {
        "validation_refs": ["7-图像/validation-report.md"],
        "source_truth_refs": ["5-分组/", "6-设计/", "7-图像/"],
        "runtime_artifact_refs": ["7-图像/"],
        "handoff_candidate_refs": ["8-视频/", "Assets/"],
    },
    "8-视频": {
        "validation_refs": ["8-视频/validation-report.md"],
        "source_truth_refs": ["7-图像/", "8-视频/"],
        "runtime_artifact_refs": ["8-视频/"],
        "handoff_candidate_refs": ["Assets/", "validation-report.md"],
    },
}
...
DIMENSION_EXPECTATIONS = {
    ...
    "detail-execution-validator": {
        "source_prefixes": ["2-编导/", "4-摄影/", "5-分组/"],
        "runtime_prefixes": ["4-摄影/", "5-分组/"],
        "validation_prefixes": ["4-摄影/", "5-分组/"],
    },
    "design-alignment-validator": {
        "source_prefixes": ["5-分组/", "6-设计/"],
        "runtime_prefixes": ["6-设计/"],
        "validation_prefixes": ["6-设计/"],
    },
    "image-delivery-validator": {
        "source_prefixes": ["5-分组/", "6-设计/", "7-图像/"],
        "runtime_prefixes": ["7-图像/"],
        "validation_prefixes": ["7-图像/"],
    },
    "video-delivery-validator": {
        "source_prefixes": ["5-分组/", "6-设计/", "7-图像/", "8-视频/"],
        "runtime_prefixes": ["8-视频/"],
        "validation_prefixes": ["8-视频/"],
    },
