...
审查对象是 `projects/aigc/<项目名>/11-主体/角色/1-清单/角色清单.md` 与可选 `执行报告.md`。审查不改写上游 `10-分组` 文件。
...
| --- | --- | --- | --- |
| `GATE-CHAR-LIST-01` | Source lock | 最终角色主体不能回指 `10-分组` 组底 YAML `角色` 字段，或来自摄影稿、剧情梗概、场景/道具清单、外部设定等非 canonical 来源 | `N2-YAML-SCAN` |
...
| --- | --- | --- | --- |
| `REV-CHAR-01` | 上游来源 | 每个条目来自 `10-分组` 组底 YAML `角色` 字段 | blocker |
