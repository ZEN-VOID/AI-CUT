...
- 本文件承接 `4-Design/角色/SKILL.md` 中下沉的角色归一化细则。
...
| `RR-02` | `运动表现 / 动作路径` 出现明确人名/称谓组合 | 记录 `shot_id + position + motion` | 若只有“他/她/众人”且无前锚，不新建角色 |
...
| `分镜明细[].运动表现 / 动作路径` | `shot_presence`、`motion_vector`、`relationship_tension_markers` | 谁在镜头里、站位层次、移动路径 |
| `分镜明细[].角色表现 / 人物表演锚点` | `performance_hook`、`expression_baseline`、`narrative_arc_position` | 动作与情绪如何被镜头消费 |
| `分镜明细[].视觉强化 / 视觉抓手` | `identity_cue`、`recognition_anchor` | 谁先被看见、服装/外形如何被识别 |
