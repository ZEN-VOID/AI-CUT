#!/usr/bin/env python3
"""Run the prop design pipeline for 4-Design/4-道具/2-设计."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="运行 4-Design/4-道具/2-设计 pipeline。")
    ...
    parser.add_argument("--output-dir", help="输出目录；默认推断到 `projects/<项目名>/4-Design/4-道具/2-设计/第N集/`")
