#!/usr/bin/env python3
"""Render already-authored prop fields into the canonical template."""
...
def main() -> int:
    ...
    print(json.dumps({"template": TEMPLATE_PATH.as_posix(), "template_name": "prop_masterprompt.structured.v2.md"}, ensure_ascii=False))
    return 0
