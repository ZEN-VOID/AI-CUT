...
- 当前还没有 `2-设计` 的合法输入，应先回退到 `4-Design/1-场景/2-设计`。
...
| 逐场景设计卡 | `projects/<项目名>/4-Design/1-场景/2-设计/第N集/<scene_key>.md` | 人读审阅与局部字段回看 |
...
- episode 输出目录：`projects/<项目名>/4-Design/1-场景/3-面板/第N集/`
...
- `objective`: 判断当前任务是否属于 `4-Design/1-场景/3-面板`
...
3. 输出路径全部位于 `projects/<项目名>/4-Design/1-场景/3-面板/第N集/`。
...
3. `.agents/skills/aigc/4-Design/1-场景/SKILL.md + CONTEXT.md`
