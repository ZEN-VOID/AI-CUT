---
name: story-validation-timeline
description: Use when `4-Validation` needs the governed child skill that checks time anchors, sequence order, duration coherence, and foreshadow timing windows.
