#!/usr/bin/env python3
"""Resolve current-round 4-Design domain targets into slot bundles."""
...
CONTRACT_PATH = SKILL_DIR / "references" / "design-slot-review-contract.md"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="把 4-Design 域级当前轮输出解析成 slot bundle。")
