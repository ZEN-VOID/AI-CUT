...
- 接入 `../_shared/upstream-context-application-contract.md`，要求导演批注证明 `4-编剧` 画面点与 `2-美学` 画面基调如何投影为导演意图、信息差、节奏和表演交接。
...
- Created `5-导演` as a Skill 2.0 runtime-spine package.
...
- Imported five `2-编导` director references into `5-导演/references/` with local adaptation notices: anticlimax strategy, directorial authorship, episode visual spine, information asymmetry, and scene rhythm.
