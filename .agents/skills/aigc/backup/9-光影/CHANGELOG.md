...
- 更新 `SKILL.md`、`README.md` 与 agent prompt，辅助分镜/角色风格也采用逐集优先、项目级回退。

## 2026-06-10

- 接入 `../_shared/upstream-context-application-contract.md`，要求光影注入证明 `7-摄影` 分镜/运镜与三类 `2-美学` 协议如何投影为光源、受光、阴影、色温、材质、空气介质和动态光。
...
- 明确默认消费 `7-摄影` 输出物，用户指定 source 优先。
- 明确必须结合 `2-美学` 的画面基调、场景风格和摄影风格，提取参照大师及作品的光影原则。
