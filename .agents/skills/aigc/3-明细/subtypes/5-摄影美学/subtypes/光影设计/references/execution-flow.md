...
3. 锁定该镜真正能成立的主光源、光向、阴影结构与叙事作用。
4. 仅生成本镜级 `摄影美学` 字段中的光影 patch，不越权改写其他 sibling 字段。
