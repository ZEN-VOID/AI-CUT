...
4. Apply `steps/resume-workflow.md`, `types/resume-type-map.md`, and `review/resume-review-gate.md`.
5. Output a recovery decision package using `templates/output-template.md`.

## Validation

```bash
python3 /Users/vincentlee/.codex/skills/meta/构建/技能/skill-工作车间/scripts/validate_skill_2_0.py .agents/skills/story/resume
```
