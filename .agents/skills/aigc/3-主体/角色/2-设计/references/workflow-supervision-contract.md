...
| `aesthetic_appeal / charisma_floor` slot 是否覆盖来源匹配审美路线、容貌、妆发、骨相、身形、服装吸引力、主角/大反派高魅力下限、普通正反派个性魅力和真实人物灵感许可/原创转译边界？ | `GATE-CHAR-DESIGN-19` | `FAIL-CHAR-DESIGN-AESTHETIC-APPEAL` | `N7-MERGE-DRAFT` | aesthetic/charisma slot evidence map、blocking findings |
