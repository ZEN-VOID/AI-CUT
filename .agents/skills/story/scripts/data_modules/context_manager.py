...
class ContextManager:
    ...
    def _load_genre_profile(self, state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        profile_text = self._load_reference_text("genre-profiles.md")
        taxonomy_text = self._load_reference_text("reading-power-taxonomy.md")
    ...
    def _load_global_cards_context(self) -> Dict[str, Any]:
        index_path = self.config.project_root / "1-设定" / "0-全局卡" / "全局索引.json"
