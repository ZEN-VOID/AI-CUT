...
| style_anchor | {{2-美学/画面基调 / 2-美学/场景风格 / team.yaml.init_synthesis / user_source}} | {{画面基调与场景风格如何转为可见色彩、质感、构图或氛围}} | {{无 / 保守化 / 非特指化}} |
