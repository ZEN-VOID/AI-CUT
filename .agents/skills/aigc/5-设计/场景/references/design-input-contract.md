# 5-设计 / 2-设计 Design Input Contract

## Purpose

- 本文件是 `5-设计/{场景,角色,道具}` 消费上游设计源的共享真源。
...
| --- | --- | --- | --- |
| `L1` | `projects/aigc/<项目名>/4-设计/<领域>/1-清单/第N集/*.json` | 提供对象主键、bridge、research、design_context | 不负责项目级风格基调裁决 |
