...
11. `projects/aigc/<项目名>/2-Global/全局风格.md`
12. `projects/aigc/<项目名>/2-Global/类型元素.md`
13. `projects/aigc/<项目名>/2-Global/导演意图.md`
14. `projects/aigc/<项目名>/4-Design/角色/1-清单/第N集/角色清单.json`
15. `projects/aigc/<项目名>/3-Detail/第N集.json` 或兼容 `projects/aigc/<项目名>/3-Detail/第N集.json`
