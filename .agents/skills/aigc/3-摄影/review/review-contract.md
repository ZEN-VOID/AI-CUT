...
| `thinking_action_node_review` | 交付前 | 检查 `PASS-CINE-*` / `N*-*` 是否完成真源锁定、类型画像、节拍、节奏、镜头时值、高点、连续性、摄影语法、功能投影、计划汇流、自然注入和阶段内修复闭环 |
...
| `GATE-CINE-17` | 思维·执行节点完整 | 产物能回指 `PASS-CINE-00..12`、`PASS-CINE-04D` 与 `N1/N2/N3/N4/N5/N5.2/N5.5/N5.6/N6/N6.1/N6.2/N6.4/N6.5/N7/N8/N8R/N9` 的关键判断：真源、类型、节拍、节奏、镜头时值、高点、顾问、连续性、边界交出、摄影语法、功能投影、计划、注入、审查修复 |
