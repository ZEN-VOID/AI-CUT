...
| 正文出现 `第6章`、`上一章`、`本轮生成` 等破次元标签 | 章节正文细则层 + 脚本校验层 | `references/chapter-drafting-contract.md` + `templates/deepseek-system-prompt.md` + `scripts/write_chapter_via_deepseek.py` |
