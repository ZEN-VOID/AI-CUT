# 4-Design / 2-设计 Slot-Level Mapping And Review Contract

## Module Identity

- `module_type`: `stage-local-shared-slot-governance-contract`
- `primary_consumers`: `4-Design/2-设计` tranche parent、`场景`、`角色`、`道具` leaf、`_shared/subagent-supervision-contract.md`
- `target_scope`: 当前轮 `2-设计` canonical truth、Markdown projection、template slot、review bundle 与 rework landing

## Purpose

本合同补足 `4-Design/2-设计` 过去只停留在“文件级 review bundle”的缺口，把共享真源下沉到更细颗粒的槽位级：
...
- `.agents/skills/aigc/4-Design/{场景,角色,道具}/references/design-output-contract.md`
- `.agents/skills/aigc/4-Design/{场景,角色,道具}/references/subagent-supervision-contract.md`
- `.agents/skills/aigc/4-Design/角色/templates/character_masterprompt.structured.v2.md`
- `.agents/skills/aigc/4-Design/道具/templates/prop_masterprompt.structured.v2.md`
- `.agents/skills/aigc/4-Design/场景/templates/scene_masterprompt.structured.v2.md`
- `.agents/skills/aigc/4-Design/角色/references/character-design-assembly.md`
- `.agents/skills/aigc/4-Design/场景/references/scene-design-assembly.md`
- `.agents/skills/aigc/4-Design/道具/references/prop-design-io-contract.md`
