...
| `stage_owner` | `0-初始化`, `1-设定`, `2-卷章规划`, `3-初稿`, `review`, `5-上下文回流`, `query`, `manual` | 下一入口 owner |
...
| --- | --- | --- | --- | --- |
| `上下文回流_completed_next_volume_ready` | `5-上下文回流/第V卷.context-return.json` | `story-write` 下一卷首章 | `low` | 列 carryover context |
