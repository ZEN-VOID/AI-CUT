...
| Output path | `projects/aigc/<项目名>/9-图像/分镜故事板/第N集/` |
...
| upstream_context | direction_role | used_as | storyboard_decision | prompt_or_output_anchor | boundary_check | evidence_map |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |
