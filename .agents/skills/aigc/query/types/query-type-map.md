...
| 分镜画面、故事板、视频、参照视频、审片报告 | `media_asset` | `12-图像/`、`13-画布/A-分镜画面参照/`、`13-画布/B-分镜故事板参照/`、`13-画布/C-主体参照/`、`13-画布/D-主板混合参照/`、`14-审片/` | 是否说明 provider 输出、阶段工件与审片结论差别 |
...
| `12-图像` | `12-图像/` | `5-Image/` |
| `13-画布` | `13-画布/{A-分镜画面参照,B-分镜故事板参照,C-主体参照,D-主板混合参照}/` | `6-Video/`、`7-Cut/` |
| `14-审片` | `14-审片/` | none |
