...
| FIELD-SB-FRAME-04 | `第N集.json / _manifest.json` | 输出文件可追溯、可继续 handoff 给后续一致性处理与图像生成 | S5 | 输出可消费性 | FAIL-SB-FRAME-04 |
...
| FIELD-SB-FRAME-04 | `第N集.json` 可追溯可 handoff；若要求 full trace，则 `_manifest.json` 同步成立 | FAIL-SB-FRAME-04 | S5 |
