...
| `script-format-report.template.md` | `OUTPUT-SCRIPT-REPORT` | `projects/aigc/<项目名>/1-Planning/2-格式/执行报告.md` | `script_format` | 必须包含每个已执行 episode 的变体裁决、validator 结果、handoff 与返工项；不得生成逐集报告侧车 |
