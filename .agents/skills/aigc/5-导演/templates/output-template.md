...
| Output path | `projects/aigc/<项目名>/5-导演/` 下的 `第N集.md` and `执行报告.md` |
| Naming convention | 单集文件沿用 `第N集.md`；批量逐集输出 |
| Completion gate | `GATE-DIR-01..21` 阻断项为 0 |
...
## Director Direction Inheritance Matrix

| source_anchor | upstream_signal | direction_role | used_as | director_direction | local_annotation_decision | output_anchor | preservation_check |
| --- | --- | --- | --- | --- | --- | --- | --- |
