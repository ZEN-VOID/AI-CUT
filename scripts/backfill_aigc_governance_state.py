...
def map_skill_from_path(path_or_stage: str) -> str:
    mapping = {
        ...
        "2-全局": "aigc-global",
        "4-编剧": "aigc-screenwriting",
        "2-编导": "aigc-screenwriting",
        "2-美学": "aigc-aesthetic-suite",
        "3-明细": "aigc-detail",
        "3-Detail": "aigc-detail",
        "3-编导": "aigc-detail",
        "3-运动": "aigc-storyboard-split",
        "5-导演": "aigc-director-annotation",
        "6-分镜": "aigc-storyboard-split",
        "7-摄影": "aigc-camera-movement-injection",
        "8-分组": "aigc-grouping",
        ...
        "5-画面": "aigc-visuals",
        "9-图像": "aigc-image-stage",
        "6-Video": "aigc-video",
        "6-视频": "aigc-video",
        "10-画布": "aigc-video-stage",
        "7-Cut": "aigc-cut",
        "query": "aigc-query",
        "resume": "aigc-resume",
    }
...
def build_governance_state(project_root: Path) -> dict[str, Any]:
    ...
    source_artifacts = [
        ...
        for relative in [
            ...
            Path("5-导演/validation-report.md"),
            Path("6-分镜/validation-report.md"),
            Path("7-摄影/validation-report.md"),
            Path("8-分组/validation-report.md"),
            Path("9-图像/validation-report.md"),
            Path("10-画布/validation-report.md"),
            project_state_rel,
