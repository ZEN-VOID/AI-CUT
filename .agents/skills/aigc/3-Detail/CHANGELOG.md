...
- `Case-20260412-AIGC-DETAIL-CINEMATOGRAPHY-LIGHTING`
  ...
  - 同步更新 `references/chain-of-thought.md`、`references/execution-flow.md`、`_shared/IO_CONTRACT.md` 与主 `SKILL.md`，固定摄影链对 `全局风格 / 类型指导 / 导演意图` 的前置吸收关系，以及 `光位 / 色彩` 并行、`光影推进 / 总协调` 串行的网络结构。
