...
description: Use when the `7-设计/1-清单` tranche needs to hold the shared `3-Detail` consumption contract and route the currently landed scene/prop list leaves under `projects/aigc/<项目名>/7-设计/`.
...
`1-清单` 是 `7-设计` 阶段承接 `3-Detail`、连接 `2-设计` 的阶段父 skill。
...
| 单元 | 当前状态 | 第一输入根 | 默认输出根 |
| --- | --- | --- | --- |
| `场景` | active | `3-Detail/第N集.json` | `7-设计/场景/1-清单/第N集/` |
| `角色` | active | `3-Detail/第N集.json` | `7-设计/角色/1-清单/第N集/` |
| `服装` | pending-migration | `7-设计/角色/1-清单/第N集/角色清单.json` | 暂不声明 active runtime；不得在初始化时预建 `7-设计/服装/*` |
| `道具` | active | `3-Detail/第N集.json` | `7-设计/道具/1-清单/第N集/` |
...
- 强制读取：`.agents/skills/aigc/7-设计/1-清单/_shared/detail-output-consumption-contract.md`
- 强制读取：`.agents/skills/aigc/7-设计/1-清单/_shared/object-normalization-contract.md`
- 强制读取：`.agents/skills/aigc/7-设计/1-清单/_shared/list-output-contract.md`
- 强制读取：`道具/SKILL.md`
- 条件读取：`场景/SKILL.md`
- 条件读取：`角色/SKILL.md`
- 条件读取：`服装/SKILL.md`
...
2. `服装` 的第一输入根固定为 `projects/aigc/<项目名>/7-设计/角色/1-清单/第N集/角色清单.json`。
...
10. `.agents/skills/aigc/7-设计/1-清单/_shared/detail-output-consumption-contract.md`
11. `.agents/skills/aigc/7-设计/1-清单/_shared/object-normalization-contract.md`
12. `.agents/skills/aigc/7-设计/1-清单/_shared/list-output-contract.md`
...
18. `projects/aigc/<项目名>/7-设计/角色/1-清单/第N集/角色清单.json`（若存在）
...
- `projects/aigc/<项目名>/7-设计/角色/1-清单/第N集/角色清单.json`
...
2. 父层只在 `projects/aigc/<项目名>/7-设计/validation-report.md` 汇总当前轮 dispatch、缺口与 handoff。
...
- `Rule Source`
  ...
  - `.agents/skills/aigc/7-设计/1-清单/_shared/detail-output-consumption-contract.md`
  - `.agents/skills/aigc/7-设计/1-清单/_shared/object-normalization-contract.md`
  - `.agents/skills/aigc/7-设计/1-清单/_shared/list-output-contract.md`
  - 四个 leaf `SKILL.md`
- `Meta Rule Source`
  - `AGENTS.md`
...
- 已给出 `projects/aigc/<项目名>/7-设计/validation-report.md` 的阶段级验收回接
