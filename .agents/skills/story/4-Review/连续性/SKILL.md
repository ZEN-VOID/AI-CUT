...
description: Use when `4-Review` needs the governed child skill that checks volume-internal carryover, chapter-to-chapter continuity, and thread persistence.
