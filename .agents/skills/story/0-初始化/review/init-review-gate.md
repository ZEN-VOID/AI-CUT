...
| next entry | 下一入口指向 `1-设定` 或明确的返工/阻塞项 | `FAIL-INIT-NEXT` |
...
test -f "./projects/story/示例小说/0-初始化/north_star.yaml"
test -f "./projects/story/示例小说/0-初始化/story-source-manifest.yaml"
test -f "./projects/story/示例小说/0-初始化/init_handoff.yaml"
```
