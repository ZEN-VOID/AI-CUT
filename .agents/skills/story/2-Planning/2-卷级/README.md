...
`story-plan-volume-level` 是 `2-Planning` 的卷级规划子技能，负责把整部总纲下钻到单卷可执行规划。
...
```bash
python3 /Users/vincentlee/.codex/skills/meta/构建/技能/skill-工作车间/scripts/validate_skill_2_0.py .agents/skills/story/2-Planning/2-卷级
```
