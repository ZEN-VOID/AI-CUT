...
7. `.agents/skills/aigc/1-Planning/references/planning-io-contract.md`
...
- `Rule Source`
  ...
  - `.agents/skills/aigc/1-Planning/references/scene-order-duration-strategy.md`
  - `.agents/skills/aigc/1-Planning/scripts/grouping_quantizer.py`
  - `.agents/skills/aigc/1-Planning/scripts/validate_grouping_output.py`
- `Meta Rule Source`
  - `AGENTS.md`
