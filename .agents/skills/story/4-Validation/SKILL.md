---
name: story-validate
description: Use when story2026 needs to audit a drafted volume against init/cards/planning truths through concurrent validation child skills before review and loopback.
...
- 当前阶段的父单元已经从“单集终验”升级为“卷级聚合终验”；卷内逐章证据仍可保留，但最终 gate truth 只认卷级 aggregate JSON。

## Overview

`4-Validation` 现在是 `story2026` 的卷级终验父 skill。
...
- `project_root`
- `volume / volume_ref`
- 当前卷全部正文 `projects/story/<项目名>/3-Drafting/第N集.md`
