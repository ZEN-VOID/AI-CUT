...
- `projects/aigc/<项目名>/11-主体/角色/2-设计/<角色名>.md`
- `.agents/skills/cli/imagegen/SKILL.md + CONTEXT.md`

输出到：

- `projects/aigc/<项目名>/11-主体/角色/3-生成/<主体ID>-<主体名称>-主图.<ext>`
- `projects/aigc/<项目名>/11-主体/角色/3-生成/<主体ID>-<主体名称>-主图.json`
- `projects/aigc/<项目名>/11-主体/角色/3-生成/<主体ID>-<主体名称>-多视图.<ext>`
- `projects/aigc/<项目名>/11-主体/角色/3-生成/<主体ID>-<主体名称>-多视图.json`
