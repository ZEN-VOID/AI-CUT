...
description: Use when the `5-设计/道具/1-清单` leaf skill needs to turn `projects/aigc/<项目名>/3-Detail/第N集.json` into `道具清单.json + 道具研究.json + prop_design_bridge.json`.
...
`1-清单` 是 `5-设计/道具` 的首个执行叶子技能，用来把 `3-Detail/第N集.json` 中已经出现的道具事实收束为可被设计阶段直接消费的三真源：
...
- `.agents/skills/aigc/5-设计/1-清单/道具/scripts/run_prop_list_pipeline.py`
- `.agents/skills/aigc/5-设计/1-清单/道具/scripts/extract_episode_props.py`
- `.agents/skills/aigc/5-设计/1-清单/道具/scripts/build_prop_research.py`

### 固定输出落点

- `projects/aigc/<项目名>/4-设计/道具/1-清单/第N集/道具清单.json`
- `projects/aigc/<项目名>/4-设计/道具/1-清单/第N集/_manifest.json`
...
```bash
python3 .agents/skills/aigc/5-设计/1-清单/道具/scripts/run_prop_list_pipeline.py \
...
python3 .agents/skills/aigc/5-设计/1-清单/道具/scripts/run_prop_list_pipeline.py \
  --input "projects/aigc/<项目名>/3-Detail/第N集.json" \
  --output-dir "projects/aigc/<项目名>/4-设计/道具/1-清单/第N集"
```
...
- `projects/aigc/<项目名>/4-设计/道具/1-清单/第N集/` 下的 `道具清单.json + 道具研究.json + prop_design_bridge.json + _manifest.json`
...
- 默认进入 `.agents/skills/aigc/5-设计/2-设计/道具`
...
| FIELD-PROP-LIST-05 | 三真源 + manifest | 同轮落盘到 `5-设计/道具/1-清单/第N集/` | NODE-PROP-LIST-06 | 落盘完整性 | FAIL-PROP-OUTPUT |
...
- `Rule Source`
  ...
  - `.agents/skills/aigc/5-设计/1-清单/道具/CONTEXT.md`
  - `.agents/skills/aigc/5-设计/1-清单/道具/scripts/run_prop_list_pipeline.py`
  - `.agents/skills/aigc/5-设计/1-清单/道具/scripts/extract_episode_props.py`
  - `.agents/skills/aigc/5-设计/1-清单/道具/scripts/build_prop_research.py`
- `Meta Rule Source`
  ...
  - `.agents/skills/aigc/_shared/project-runtime-layout.md`
  - `.agents/skills/aigc/5-设计/1-清单/_shared/detail-output-consumption-contract.md`
  - `.agents/skills/aigc/5-设计/1-清单/_shared/object-normalization-contract.md`
  - 根 `AGENTS.md`
...
4. `.agents/skills/aigc/5-设计/1-清单/SKILL.md + CONTEXT.md`
5. `.agents/skills/aigc/5-设计/1-清单/_shared/detail-output-consumption-contract.md`
6. `.agents/skills/aigc/5-设计/1-清单/_shared/object-normalization-contract.md`
