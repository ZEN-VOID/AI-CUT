...
> **契约地位**：本文件为 `2-编剧` 提供 AIGC 图像/视频生成的视觉信号映射规范，是 field-routing-and-audio-visual-contract.md §11 的扩展和深化。
...
> **来源**：field-routing-and-audio-visual-contract.md §11
...
| 本文件章节 | 对应规则/文档 | 说明 |
|-----------|-------------|------|
| §2 字段映射 | field-routing §11 | 27种字段的 AIGC 参数 |
