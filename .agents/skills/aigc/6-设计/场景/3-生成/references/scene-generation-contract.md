...
```text
projects/aigc/<项目名>/6-设计/场景/2-设计/S###-<场景名>.md
```
...
```text
projects/aigc/<项目名>/6-设计/场景/3-生成/<主体ID>-<主体名称>-主图.<ext>
projects/aigc/<项目名>/6-设计/场景/3-生成/<主体ID>-<主体名称>-主图.json
```
...
```text
projects/aigc/<项目名>/6-设计/场景/3-生成/<主体ID>-<主体名称>-多视图.<ext>
projects/aigc/<项目名>/6-设计/场景/3-生成/<主体ID>-<主体名称>-多视图.json
```
...
| Does each Step1 deliver a project-bound `<主体ID>-<主体名称>-主图.<ext>` asset under `projects/aigc/<项目名>/6-设计/场景/3-生成`? | `REV-SCENE-GEN-03` | `FAIL-SCENE-GEN-03` | `N4-MAIN` | main image output path, filesystem existence check, generation mode, persistence action |
