...
- 根目录：`projects/<项目名>/主体/4-面板/`
- 角色：
  - `projects/<项目名>/主体/4-面板/角色面板/第N集/[角色名]-面板.md`
  - `projects/<项目名>/主体/4-面板/角色面板/第N集/[角色名]-layout.json`
- 场景：
  - `projects/<项目名>/主体/4-面板/场景面板/第N集/[场景名]-面板.md`
  - `projects/<项目名>/主体/4-面板/场景面板/第N集/[场景名]-layout.json`
- 道具：
  - `projects/<项目名>/主体/4-面板/道具面板/第N集/[道具名]-面板.md`
  - `projects/<项目名>/主体/4-面板/道具面板/第N集/[道具名]-layout.json`
- 验收：`projects/<项目名>/主体/4-面板/validation-report.md`
